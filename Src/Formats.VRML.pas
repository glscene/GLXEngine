...
type
  ...
  private
    FValues: TGSSingleList;
  public
    constructor Create; override;
    destructor Destroy; override;
    property Values: TGSSingleList read FValues;
  end;

  TVRMLIntegerArray = class(TVRMLNode)
  private
    FValues: TGSIntegerList;
  public
    constructor Create; override;
    destructor Destroy; override;
    property Values: TGSIntegerList read FValues;
  end;
