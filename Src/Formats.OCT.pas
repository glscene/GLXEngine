...
type
  ...
  public
    ...
    procedure AddTriangles(vertexCoords: TGSAffineVectorList;
      texMapCoords: TGSAffineVectorList; const textureName: String);
    procedure AddLight(const lightPos: TAffineVector; const lightColor: TGSVector;
...
//---------------------------------------------------------------------------
procedure TOCTFile.AddTriangles(vertexCoords: TGSAffineVectorList;
  texMapCoords: TGSAffineVectorList; const textureName: String);
var
  i: Integer;
...
procedure TOCTFile.AddLight(const lightPos: TAffineVector;
  const lightColor: TGSVector; lightIntensity: Integer);
var
  n: Integer;
begin
  n := Length(Lights);
