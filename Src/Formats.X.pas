...
type
  ...
  TDXMaterial = class(TGSPersistentObject)
  private
    FDiffuse: TVector4f;
    FSpecPower: Single;
  ...
  public
    ...
    function GlobalMatrix: TGSMatrix;
    property Matrix: TGSMatrix read FMatrix write FMatrix;

  end;

  TDXMesh = class(TDXNode)
  private
    FVertices, FNormals, FTexCoords: TGSAffineVectorList;
  ...
  public
    ...
    property VertexIndices: TGSIntegerList read FVertexIndices;
    property NormalIndices: TGSIntegerList read FNormalIndices;
    property MaterialIndices: TGSIntegerList read FMaterialIndices;
    property VertCountIndices: TGSIntegerList read FVertCountIndices;
...
var
  ...
  function ReadVector4f: TGSVector;
  var
    str: String;
  begin
    str := ReadString;
  ...
  procedure ReadMeshVectors(VectorList: TGSAffineVectorList);
  var
  ...
  procedure ReadMeshIndices(IndexList: TGSIntegerList;
    VertCountIndices: TGSIntegerList = nil);
  var
    str: String;
  ...
  procedure ReadTexCoords(VectorList: TGSAffineVectorList);
  var
    i, NumVectors: Integer;
  begin
    NumVectors := ReadInteger;
...
begin
  ...
  FMaterialIndices := TGSIntegerList.Create;
  FVertCountIndices := TGSIntegerList.Create;
...
function TDXFrame.GlobalMatrix: TGSMatrix;
begin
