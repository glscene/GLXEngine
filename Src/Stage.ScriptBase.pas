...
******************************************************************************)
unit Stage.ScriptBase;
(*
  An abstract scripting interface
  RegisterClasses([TGSScriptLibrary, TGSScripts, TGSScriptBase]);
...
type
  ...
  TGSScriptLibrary = class(TComponent)
  private
    FScripts: TGSScripts;
  protected
...
// --------------- TGSScriptLibrary ---------------
// ---------------
constructor TGSScriptLibrary.Create(aOwner: TComponent);
begin
  inherited;
...
//---------------------------------------------------------------------------
destructor TGSScriptLibrary.Destroy;
begin
  FScripts.Free;
  inherited;
end;
...
//---------------------------------------------------------------------------
procedure TGSScriptLibrary.DefineProperties(Filer: TFiler);
begin
  inherited;
...
//---------------------------------------------------------------------------
procedure TGSScriptLibrary.WriteScriptsData(Stream: TStream);
var
  writer: TWriter;
begin
...
//---------------------------------------------------------------------------
procedure TGSScriptLibrary.ReadScriptsData(Stream: TStream);
var
  reader: TReader;
begin
...
//---------------------------------------------------------------------------
procedure TGSScriptLibrary.Loaded;
begin
  inherited;
  Scripts.Loaded;
end;
...
//---------------------------------------------------------------------------
procedure TGSScriptLibrary.Notification(AComponent: TComponent;
  Operation: TOperation);
var
  i: Integer;
begin
