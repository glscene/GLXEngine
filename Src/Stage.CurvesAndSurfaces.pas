...
procedure GenerateBezierCurve(Steps: integer;  ControlPoints, Vertices: TGSAffineVectorList);
procedure GenerateBezierSurface(Steps, Width, Height: integer; ControlPoints, Vertices: TGSAffineVectorList);
...
procedure GenerateBSpline(Steps, Order: integer; KnotVector: TGSSingleList;
  ControlPoints, Vertices: TGSAffineVectorList);
procedure GenerateBSplineSurface(Steps, UOrder, VOrder, Width, Height: integer;
  UKnotVector, VKnotVector: TGSSingleList;
  ControlPoints, Vertices: TGSAffineVectorList);
procedure GenerateKnotVector(KnotVector: TGSSingleList;
...
//---------------------------------------------------------------------------
procedure GenerateBSplineSurface(Steps, UOrder, VOrder, Width, Height: integer;
  UKnotVector, VKnotVector: TGSSingleList; ControlPoints, Vertices: TGSAffineVectorList);
var
  i, j: integer;
begin
  Vertices.Clear;
