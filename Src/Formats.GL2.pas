...
type
  ...
  TACompQuatBone = array [0 .. 6] of Word; { 14 bytes }
  ...
  public
    ...
    CompBonePool: array of TACompQuatBone;
    function GetCompressedMatrix(Frame, Bone: integer): TACompQuatBone;
    function GetUnCompressedMatrix(Frame, Bone: integer): TGSMatrix;
    procedure LoadFromStream(aStream: TStream);
  end;
...
procedure MC_UnCompressQuat(var mat: TGSMatrix; const comp: TACompQuatBone);
...
function TFileGLA.GetCompressedMatrix(Frame, Bone: integer): TACompQuatBone;
begin
...
//
function TFileGLA.GetUnCompressedMatrix(Frame, Bone: integer): TGSMatrix;
begin
...
begin
  ...
  SetLength(CompBonePool, temp div sizeof(TACompQuatBone));
