...
unit GLS.Logger;
(*
  Activate USE_LOGGING in "Stage.Defines.inc" to turn on inner Scene logger.
  TGLLogger = class(TComponent)

  You may have only one instance of TGLLogger
...
// Return logger wich created by TGLLogger component
...
constructor TGLLogger.Create(AOwner: TComponent);
begin
...
function TGLLogger.GetLog: TLogSession;
begin
...
procedure TGLLogger.DoPrimary;
begin
  vCurrentLogger := Self;
end;

procedure TGLLogger.SetReplaceAssertion(Value: Boolean);
begin
