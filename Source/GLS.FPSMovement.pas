...
type
  ...
  private
    ...
    procedure DrawArrows(intPoint, intNormal, Ray: TGSVector;
  ...
  public
    ...
    function SphereSweepAndSlide(freeform: TGLFreeForm;
      ...
      var Velocity, newPosition: TGSVector; sphereRadius: single): boolean; overload;
