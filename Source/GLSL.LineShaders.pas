...
type
  TGLLineSettings = class(TGSUpdateAbleObject)
  private
    FColor: TGSColor;
    FWidth: Single;
    FPattern: TGLushort;
...
procedure TGLLineSettings.SetColor(const v: TGSColor);
begin
...
procedure TGLHiddenLineShader.SetBackgroundColor(AColor: TGSColor);
begin
