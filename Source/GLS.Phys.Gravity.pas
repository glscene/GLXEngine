...
type
  ...
  protected
    procedure SetGravity(const val: TGSCoordinates);
  public
...
begin
  ...
  fGravity := TGSCoordinates.CreateInitialized(Self, nullHmgVector, csVector);
end;
...
procedure TGLUniformGravityEmitter.SetGravity(const val: TGSCoordinates);
begin
  fGravity.Assign(val);
end;
