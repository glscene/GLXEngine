...
type
  ...
  TGLCustomCadencedComponent = class(TGSUpdateAbleComponent)
  private
...
//---------------------------------------------------------------------------
procedure TGLCadencer.Subscribe(aComponent: TGSCadenceAbleComponent);
begin
...
//---------------------------------------------------------------------------
procedure TGLCadencer.UnSubscribe(aComponent: TGSCadenceAbleComponent);
var
  i: Integer;
begin
