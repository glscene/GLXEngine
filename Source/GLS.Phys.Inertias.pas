...
type
  ...
  TGLInertiaTensor = class(TGSUpdateAbleObject)
  private
...
procedure TGLParticleInertia.SetTranslationSpeed(const val: TGSCoordinates);
begin
...
procedure TGLParticleInertia.SurfaceBounce(const surfaceNormal: TGSVector;
  restitution: Single);
var
  f: Single;
begin
...
procedure TGLRigidBodyInertia.SetRotationSpeed(const val: TGSCoordinates);
begin
...
(*
 function TGLRigidBodyInertia.Star(Vector:TAffineVector):TGSMatrix;
  begin
