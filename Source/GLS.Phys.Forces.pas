...
type
  ...
  private
    ...
    fposition1: TGSCoordinates;
    fposition2: TGSCoordinates;
    object1Name: String;
    object2Name: String;
  ...
  public
    ...
    procedure SetPosition1(const val: TGSCoordinates);
    procedure SetPosition2(const val: TGSCoordinates);
  ...
  published
    ...
    property Position1: TGSCoordinates read fposition1 write SetPosition1;
    property Position2: TGSCoordinates read fposition2 write SetPosition2;
...
begin
  ...
  fposition1 := TGSCoordinates.CreateInitialized(Self, NullHmgVector, csVector);
  fposition2 := TGSCoordinates.CreateInitialized(Self, NullHmgVector, csVector);
...
procedure TGLForce.SetPosition1(const val: TGSCoordinates);
begin
  fposition1.Assign(val); // DB101
end;

procedure TGLForce.SetPosition2(const val: TGSCoordinates);
begin
...
var
  PhysMan: TGLPhysManager;
begin
  inherited Loaded;
  // not nice at all!!!
  // assumes owner is TGLForces belonging to TGLPhysicsManager
  PhysMan := TGLPhysManager(Self.Owner.Owner);
  if (object1Name <> '') then
  begin
