  ...
  *)
  TgxDwsActiveBehaviour = class (TgxBehaviour)
    ...
    public
      ...
      procedure DoProgress(const ProgressTimes : TGSProgressTimes); override;
...
procedure TgxDwsActiveBehaviour.DoProgress(const ProgressTimes: TGSProgressTimes);
var
  Symbol : TSymbol;
begin
  inherited;
