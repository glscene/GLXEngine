...
// (DO NOT EDIT: machine generated header) 'GLS.LensFlare.pas' rev: 36.00 (Windows)
...
public:
	...
	__fastcall TGLFlareGradient(System::Classes::TPersistent* AOwner, const Gls::Color::TGLColorVector &fromColor, const Gls::Color::TGLColorVector &toColor);
