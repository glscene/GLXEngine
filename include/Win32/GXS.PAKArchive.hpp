...
// (DO NOT EDIT: machine generated header) 'GXS.PAKArchive.pas' rev: 36.00 (Windows)

#ifndef GXS_PAKArchiveHPP
#define GXS_PAKArchiveHPP
...
class PASCALIMPLEMENTATION TPAKArchive : public Gxs::Archivemanager::TgxBaseArchive
{
	typedef Gxs::Archivemanager::TgxBaseArchive inherited;
...
protected:
	virtual void __fastcall SetCompressionLevel(Gxs::Archivemanager::TCompressionLevel aValue);
...
public:
	/* TgxBaseArchive.Create */ inline __fastcall virtual TPAKArchive(System::Classes::TPersistent* AOwner) : Gxs::Archivemanager::TgxBaseArchive(AOwner) { }
	/* TgxBaseArchive.Destroy */ inline __fastcall virtual ~TPAKArchive() { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GXS_PAKARCHIVE)
using namespace Gxs::Pakarchive;
#endif
