...
// (DO NOT EDIT: machine generated header) 'GXS.HiddenLineShader.pas' rev: 36.00 (Windows)

#ifndef GXS_HiddenLineShaderHPP
#define GXS_HiddenLineShaderHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GXS_HIDDENLINESHADER)
using namespace Gxs::Hiddenlineshader;
#endif
