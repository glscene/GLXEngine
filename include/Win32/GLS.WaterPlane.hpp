...
// (DO NOT EDIT: machine generated header) 'GLS.WaterPlane.pas' rev: 36.00 (Windows)
...
public:
	...
	void __fastcall CreateRippleAtWorldPos(const Stage::Vectortypes::TGLVector &pos)/* overload */;
