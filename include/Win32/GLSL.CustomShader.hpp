...
// (DO NOT EDIT: machine generated header) 'GLSL.CustomShader.pas' rev: 36.00 (Windows)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EGLCustomShaderException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : Gls::Texture::EGLShaderException(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EGLCustomShaderException(System::NativeUInt Ident)/* overload */ : Gls::Texture::EGLShaderException(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EGLCustomShaderException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Gls::Texture::EGLShaderException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EGLCustomShaderException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Gls::Texture::EGLShaderException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EGLCustomShaderException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : Gls::Texture::EGLShaderException(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EGLCustomShaderException(System::NativeUInt Ident, int AHelpContext)/* overload */ : Gls::Texture::EGLShaderException(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EGLCustomShaderException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Gls::Texture::EGLShaderException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EGLCustomShaderException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Gls::Texture::EGLShaderException(Ident, Args, Args_High, AHelpContext) { }
...
{
	virtual void __fastcall SetShaderTextures(Gls::Texture::TGLTexture* const *Textures, const System::NativeInt Textures_High) = 0 ;
	virtual void __fastcall GetShaderTextures(Gls::Texture::TGLTexture* *Textures, const System::NativeInt Textures_High) = 0 ;
...
{
	virtual void __fastcall DoUseTempTexture(Gls::Context::TGLTextureHandle* const TempTexture, Stage::Textureformat::TglTextureTarget TextureTarget) = 0 ;
...
private:
	...
	Stage::Opengltokens::TGLint FVerticesOut;
	...
	void __fastcall SetVerticesOut(const Stage::Opengltokens::TGLint Value);
...
__published:
	...
	__property Stage::Opengltokens::TGLint VerticesOut = {read=FVerticesOut, write=SetVerticesOut, default=0};
public:
...
protected:
	...
	virtual Stage::Vectortypes::TGLVector __fastcall GetAsVector4f() = 0 ;
...
public:
	...
	__property Stage::Vectortypes::TGLVector AsVector = {read=GetAsVector4f, write=SetAsVector4f};
...
extern DELPHI_PACKAGE void __fastcall InitTexture(const unsigned TextureHandle, const Gls::Rendercontextinfo::TGLSize &TextureSize, const Stage::Textureformat::TglTextureTarget TextureTarget = (Stage::Textureformat::TglTextureTarget)(0x2));
}	/* namespace Customshader */
}	/* namespace Glsl */
