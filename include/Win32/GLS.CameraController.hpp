...
// (DO NOT EDIT: machine generated header) 'GLS.CameraController.pas' rev: 36.00 (Windows)
...
private:
	Stage::Vectortypes::TGLVector FInitialPos;
	Stage::Vectortypes::TGLVector FFinalPos;
...
public:
	...
	__property Stage::Vectortypes::TGLVector InitialPos = {read=FInitialPos};
	__property Stage::Vectortypes::TGLVector FinalPos = {read=FFinalPos};
public:
...
private:
	...
	Stage::Vectortypes::TGLVector FCameraUpVector;
	Stage::Vectortypes::TGLVector FTargetPosition;
	double FTime;
...
public:
	...
	__property Stage::Vectortypes::TGLVector CameraUpVector = {read=FCameraUpVector};
	__property Stage::Vectortypes::TGLVector TargetPosition = {read=FTargetPosition};
	__property Stage::Vectortypes::TGLVector FinalPos = {read=FFinalPos};
...
private:
	...
	Stage::Vectortypes::TGLMatrix FShouldBeMatrix;
...
private:
	Stage::Vectortypes::TGLVector FInitialPos;
	Stage::Vectortypes::TGLVector FFinalPos;
	Stage::Vectortypes::TGLVector FInitialUp;
	Stage::Vectortypes::TGLVector FInitialDir;
	Stage::Vectortypes::TGLVector FRotAxis;
	double FAngle;
...
public:
	...
	virtual void __fastcall Init();
	__property Stage::Vectortypes::TGLVector InitialPos = {read=FInitialPos};
	__property Stage::Vectortypes::TGLVector InitialUp = {read=FInitialUp};
	__property Stage::Vectortypes::TGLVector InitialDir = {read=FInitialDir};
	__property Stage::Vectortypes::TGLVector FinalPos = {read=FFinalPos};
public:
...
private:
	Stage::Vectortypes::TGLVector FPreviousPosition;
	Gls::Smoothnavigator::TGLNavigatorSmoothChangeVector* FSmoothNavigator;
...
public:
	...
	TGLSmoothOrbitToPos* __fastcall OrbitToPosSmooth(const Stage::Vectortypes::TGLVector &ATargetPosition, const double ATime, Gls::Smoothnavigator::TGLNavigatorSmoothChangeVector* const ASmoothNavigator, const bool AFNeedToRecalculateZoom, const Stage::Vectortypes::PGLVector ACameraUpVector = (Stage::Vectortypes::PGLVector)(0x0));
