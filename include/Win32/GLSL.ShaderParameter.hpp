...
// (DO NOT EDIT: machine generated header) 'GLSL.ShaderParameter.pas' rev: 36.00 (Windows)
...
__interface IShaderParameter  : public System::IInterface 
{
	...
	virtual void __fastcall SetFloat(const Stage::Opengltokens::TGLfloat Value) = 0 ;
	...
	__property Stage::Opengltokens::TGLfloat Float = {read=GetFloat, write=SetFloat};
