...
// (DO NOT EDIT: machine generated header) 'GLSL.BumpShaders.pas' rev: 36.00 (Windows)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EGLSLBumpShaderException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : Glsl::Shader::EGLSLShaderException(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EGLSLBumpShaderException(System::NativeUInt Ident)/* overload */ : Glsl::Shader::EGLSLShaderException(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EGLSLBumpShaderException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Glsl::Shader::EGLSLShaderException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EGLSLBumpShaderException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Glsl::Shader::EGLSLShaderException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EGLSLBumpShaderException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : Glsl::Shader::EGLSLShaderException(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EGLSLBumpShaderException(System::NativeUInt Ident, int AHelpContext)/* overload */ : Glsl::Shader::EGLSLShaderException(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EGLSLBumpShaderException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Glsl::Shader::EGLSLShaderException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EGLSLBumpShaderException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Glsl::Shader::EGLSLShaderException(Ident, Args, Args_High, AHelpContext) { }
...
private:
	...
	Gls::Material::TGLLibMaterialName FNormalTextureName;
	Gls::Material::TGLLibMaterialName FSpecularTextureName;
	Gls::Material::TGLLibMaterialName __fastcall GetNormalTextureName();
	Gls::Material::TGLLibMaterialName __fastcall GetSpecularTextureName();
	void __fastcall SetNormalTextureName(const Gls::Material::TGLLibMaterialName Value);
	void __fastcall SetSpecularTextureName(const Gls::Material::TGLLibMaterialName Value);
...
public:
	...
	__property Gls::Material::TGLLibMaterialName NormalTextureName = {read=GetNormalTextureName, write=SetNormalTextureName};
	__property Gls::Material::TGLLibMaterialName SpecularTextureName = {read=GetSpecularTextureName, write=SetSpecularTextureName};
...
private:
	void __fastcall SetShaderTextures(Gls::Texture::TGLTexture* const *Textures, const System::NativeInt Textures_High);
	void __fastcall GetShaderTextures(Gls::Texture::TGLTexture* *Textures, const System::NativeInt Textures_High);
