...
// (DO NOT EDIT: machine generated header) 'GLS.Isolines.pas' rev: 36.00 (Windows)
...
extern DELPHI_PACKAGE void __fastcall TriangleElevationSegments(const Stage::Vectorgeometry::TAffineVector &p1, const Stage::Vectorgeometry::TAffineVector &p2, const Stage::Vectorgeometry::TAffineVector &p3, float ElevationDelta, Gls::Vectorlists::TGLAffineVectorList* Segments);
}	/* namespace Isolines */
}	/* namespace Gls */
