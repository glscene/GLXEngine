...
// (DO NOT EDIT: machine generated header) 'Formatx.DXTC.pas' rev: 36.00 (Windows)

#ifndef Formatx_DXTCHPP
#define Formatx_DXTCHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FORMATX_DXTC)
using namespace Formatx::Dxtc;
#endif
