...
// (DO NOT EDIT: machine generated header) 'GLS.CUDA.Compiler.pas' rev: 36.00 (Windows)

#ifndef GLS_CUDA_CompilerHPP
#define GLS_CUDA_CompilerHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLS_CUDA_COMPILER)
using namespace Gls::Cuda::Compiler;
#endif
