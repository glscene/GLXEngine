...
// (DO NOT EDIT: machine generated header) 'GLS.BumpmapHDS.pas' rev: 36.00 (Windows)
...
//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE void __fastcall CalcObjectSpaceLightVectors(const Stage::Vectorgeometry::TAffineVector &Light, Gls::Vectorlists::TGLAffineVectorList* Vertices, Gls::Vectorlists::TGLVectorList* Colors);
...
extern DELPHI_PACKAGE void __fastcall CalcTangentSpaceLightVectors(const Stage::Vectorgeometry::TAffineVector &Light, Gls::Vectorlists::TGLAffineVectorList* Vertices, Gls::Vectorlists::TGLAffineVectorList* Normals, Gls::Vectorlists::TGLAffineVectorList* Tangents, Gls::Vectorlists::TGLAffineVectorList* BiNormals, Gls::Vectorlists::TGLVectorList* Colors);
