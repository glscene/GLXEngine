...
// (DO NOT EDIT: machine generated header) 'GLS.AsyncHDS.pas' rev: 36.00 (Windows)
...
public:
	...
	/* TThread.Create */ inline __fastcall TGLAsyncHDThread(bool CreateSuspended, System::NativeUInt ReservedStackSize)/* overload */ : Gls::Heightdata::TGLHeightDataThread(CreateSuspended, ReservedStackSize) { }
