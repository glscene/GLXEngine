...
// (DO NOT EDIT: machine generated header) 'GLS.PhysJoints.pas' rev: 36.00 (Windows)

#ifndef GLS_PhysJointsHPP
#define GLS_PhysJointsHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLS_PHYSJOINTS)
using namespace Gls::Physjoints;
#endif
