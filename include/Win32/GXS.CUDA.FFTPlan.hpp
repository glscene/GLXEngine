...
// (DO NOT EDIT: machine generated header) 'GXS.CUDA.FFTPlan.pas' rev: 36.00 (Windows)

#ifndef GXS_CUDA_FFTPlanHPP
#define GXS_CUDA_FFTPlanHPP
...
class PASCALIMPLEMENTATION TCUDAFFTPlan : public Gxs::Cuda::Api::TCUDAComponent
{
	typedef Gxs::Cuda::Api::TCUDAComponent inherited;
...
public:
	...
	void __fastcall Execute(Gxs::Cuda::Api::TCUDAMemData* ASrc, Gxs::Cuda::Api::TCUDAMemData* ADst, const TCUDAFFTdir ADir = (TCUDAFFTdir)(0x0));
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GXS_CUDA_FFTPLAN)
using namespace Gxs::Cuda::Fftplan;
#endif
