...
// (DO NOT EDIT: machine generated header) 'Formatx.B3D.pas' rev: 36.00 (Windows)

#ifndef Formatx_B3DHPP
#define Formatx_B3DHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FORMATX_B3D)
using namespace Formatx::B3d;
#endif
