...
// (DO NOT EDIT: machine generated header) 'GLS.Perlin.pas' rev: 36.00 (Windows)
...
public:
	...
	/* TThread.Create */ inline __fastcall TGLPerlinHDSThread(bool CreateSuspended, System::NativeUInt ReservedStackSize)/* overload */ : Gls::Heightdata::TGLHeightDataThread(CreateSuspended, ReservedStackSize) { }
