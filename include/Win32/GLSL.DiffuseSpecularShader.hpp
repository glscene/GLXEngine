...
// (DO NOT EDIT: machine generated header) 'GLSL.DiffuseSpecularShader.pas' rev: 36.00 (Windows)
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall EGLSLDiffuseSpecularShaderException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : Glsl::Shader::EGLSLShaderException(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall EGLSLDiffuseSpecularShaderException(System::NativeUInt Ident)/* overload */ : Glsl::Shader::EGLSLShaderException(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall EGLSLDiffuseSpecularShaderException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Glsl::Shader::EGLSLShaderException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall EGLSLDiffuseSpecularShaderException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Glsl::Shader::EGLSLShaderException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall EGLSLDiffuseSpecularShaderException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : Glsl::Shader::EGLSLShaderException(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall EGLSLDiffuseSpecularShaderException(System::NativeUInt Ident, int AHelpContext)/* overload */ : Glsl::Shader::EGLSLShaderException(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall EGLSLDiffuseSpecularShaderException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Glsl::Shader::EGLSLShaderException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall EGLSLDiffuseSpecularShaderException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Glsl::Shader::EGLSLShaderException(Ident, Args, Args_High, AHelpContext) { }
