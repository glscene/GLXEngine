...
// (DO NOT EDIT: machine generated header) 'GLS.Canvas.pas' rev: 36.00 (Windows)
...
private:
	...
	int FPenWidth;
	Stage::Vectortypes::TGLVector FCurrentPenColorVector;
...
public:
	__fastcall TGLCanvas(int bufferSizeX, int bufferSizeY, const Stage::Vectortypes::TGLMatrix &baseTransform)/* overload */;
	...
	void __fastcall FillRectGradient(const float x1, const float y1, const float x2, const float y2, const Gls::Color::TGLColorVector &x1y1Color, const Gls::Color::TGLColorVector &x2y1Color, const Gls::Color::TGLColorVector &x2y2Color, const Gls::Color::TGLColorVector &x1y2Color)/* overload */;
	void __fastcall FillRectGradient(const int x1, const int y1, const int x2, const int y2, const Gls::Color::TGLColorVector &x1y1Color, const Gls::Color::TGLColorVector &x2y1Color, const Gls::Color::TGLColorVector &x2y2Color, const Gls::Color::TGLColorVector &x1y2Color)/* overload */;
	...
	void __fastcall FillEllipseGradient(const float x, const float y, const float xRadius, const float yRadius, const Gls::Color::TGLColorVector &edgeColor)/* overload */;
	void __fastcall FillEllipseGradient(const int x, const int y, const int xRadius, const int yRadius, const Gls::Color::TGLColorVector &edgeColor)/* overload */;
	void __fastcall FillEllipseGradient(const float x, const float y, const float Radius, const Gls::Color::TGLColorVector &edgeColor)/* overload */;
