...
// (DO NOT EDIT: machine generated header) 'GLS.MeshLines.pas' rev: 36.00 (Windows)
...
private:
	...
	Stage::Opengltokens::TGLfloat __fastcall GetRight();
	Stage::Opengltokens::TGLfloat __fastcall GetBottom();
	Stage::Opengltokens::TGLfloat __fastcall GetWidth();
	Stage::Opengltokens::TGLfloat __fastcall GetHeight();
	...
	void __fastcall SetRight(const Stage::Opengltokens::TGLfloat Value);
	void __fastcall SetBottom(const Stage::Opengltokens::TGLfloat Value);
	
__published:
	__property Stage::Opengltokens::TGLfloat Left = {read=GetLeft, write=SetLeft, stored=false};
	__property Stage::Opengltokens::TGLfloat Top = {read=GetTop, write=SetTop, stored=false};
	__property Stage::Opengltokens::TGLfloat Right = {read=GetRight, write=SetRight, stored=false};
	__property Stage::Opengltokens::TGLfloat Bottom = {read=GetBottom, write=SetBottom, stored=false};
	__property Stage::Opengltokens::TGLfloat Width = {read=GetWidth};
	__property Stage::Opengltokens::TGLfloat Height = {read=GetHeight};
public:
	/* TGLCustomCoordinates.CreateInitialized */ inline __fastcall TGLLightmapBounds(System::Classes::TPersistent* AOwner, const Stage::Vectortypes::TGLVector &AValue, const Gls::Coordinates::TGLCoordinatesStyle AStyle) : Gls::Coordinates::TGLCustomCoordinates(AOwner, AValue, AStyle) { }
...
private:
	...
	void __fastcall AddVertices(const Stage::Vectorgeometry::TAffineVector &Up, const Stage::Vectorgeometry::TAffineVector &Inner, const Stage::Vectorgeometry::TAffineVector &Outer, float S, float Correction, bool UseDegenerate, TGLLineItem* LineItem);
