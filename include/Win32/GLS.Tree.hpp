...
// (DO NOT EDIT: machine generated header) 'GLS.Tree.pas' rev: 36.00 (Windows)
...
public:
	...
	void __fastcall AddNew(const Stage::Vectortypes::TGLMatrix &matrix);
...
private:
	...
	bool FCentralLeader;
	void __fastcall BuildBranch(TGLTreeBranchNoise* branchNoise, const Stage::Vectortypes::TGLMatrix &matrix, float TexCoordY, float Twist, int Level);
...
private:
	...
	Gls::Material::TGLLibMaterialName FLeafMaterialName;
	Gls::Material::TGLLibMaterialName FLeafBackMaterialName;
	Gls::Material::TGLLibMaterialName FBranchMaterialName;
	bool FRebuildTree;
...
protected:
	...
	void __fastcall SetLeafMaterialName(const Gls::Material::TGLLibMaterialName Value);
	void __fastcall SetLeafBackMaterialName(const Gls::Material::TGLLibMaterialName Value);
	void __fastcall SetBranchMaterialName(const Gls::Material::TGLLibMaterialName Value);
...
__published:
	...
	__property Gls::Material::TGLLibMaterialName LeafMaterialName = {read=FLeafMaterialName, write=SetLeafMaterialName};
	__property Gls::Material::TGLLibMaterialName LeafBackMaterialName = {read=FLeafBackMaterialName, write=SetLeafBackMaterialName};
	__property Gls::Material::TGLLibMaterialName BranchMaterialName = {read=FBranchMaterialName, write=SetBranchMaterialName};
public:
