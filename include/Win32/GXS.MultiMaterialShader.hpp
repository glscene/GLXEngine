...
// (DO NOT EDIT: machine generated header) 'GXS.MultiMaterialShader.pas' rev: 36.00 (Windows)

#ifndef GXS_MultiMaterialShaderHPP
#define GXS_MultiMaterialShaderHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GXS_MULTIMATERIALSHADER)
using namespace Gxs::Multimaterialshader;
#endif
...
//-- end unit ----------------------------------------------------------------
#endif	// GXS_MultiMaterialShaderHPP
