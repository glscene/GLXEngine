...
// (DO NOT EDIT: machine generated header) 'GLS.MeshUtils.pas' rev: 36.00 (Windows)
...
extern DELPHI_PACKAGE Gls::Vectorlists::TGLLongWordList* __fastcall MakeTriangleAdjacencyList(const Stage::Vectorgeometry::PLongWordArray AindicesList, System::LongWord Count, const Stage::Vectorgeometry::PAffineVectorArray AVerticesList);
extern DELPHI_PACKAGE Gls::Vectorlists::TGLLongWordList* __fastcall ConvertStripToList(const Stage::Vectorgeometry::PLongWordArray AindicesList, System::LongWord Count, System::LongWord RestartIndex)/* overload */;
extern DELPHI_PACKAGE Gls::Vectorlists::TGLLongWordList* __fastcall ConvertFansToList(const Stage::Vectorgeometry::PLongWordArray AindicesList, System::LongWord Count, System::LongWord RestartIndex);
}	/* namespace Meshutils */
}	/* namespace Gls */
