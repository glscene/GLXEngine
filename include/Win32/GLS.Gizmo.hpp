...
// (DO NOT EDIT: machine generated header) 'GLS.Gizmo.pas' rev: 36.00 (Windows)
...
private:
	...
	Gls::Coordinates::TGLCoordinates* FOldAutoScaling;
	Gls::Scene::TGLCustomSceneObject* FEffectedObject;
	Stage::Vectortypes::TGLMatrix FOldMatr;
	Stage::Vectortypes::TGLMatrix FOldMatrix;
	void __fastcall SetEffectedObject(Gls::Scene::TGLCustomSceneObject* const Value);
	void __fastcall SetOldAutoScaling(Gls::Coordinates::TGLCoordinates* const Value);
	void __fastcall SetOldMatrix(const Stage::Vectortypes::TGLMatrix &Value);
...
public:
	...
	__property Stage::Vectortypes::TGLMatrix OldMatrix = {read=FOldMatrix, write=SetOldMatrix};
	
__published:
	__property Gls::Scene::TGLCustomSceneObject* EffectedObject = {read=FEffectedObject, write=SetEffectedObject};
	__property Gls::Coordinates::TGLCoordinates* OldAutoScaling = {read=FOldAutoScaling, write=SetOldAutoScaling};
...
typedef void __fastcall (__closure *TGLGizmoAcceptEvent)(System::TObject* Sender, Gls::Scene::TGLBaseSceneObject* &Obj, bool &Accept, Stage::Vectortypes::TGLVector &Dimensions);

typedef void __fastcall (__closure *TGLGizmoUpdateEvent)(System::TObject* Sender, Gls::Scene::TGLBaseSceneObject* Obj, TGLGizmoAxis Axis, TGLGizmoOperation Operation, Stage::Vectortypes::TGLVector &Vector);
...
public:
	...
	Stage::Vectortypes::TGLVector Point;
public:
...
private:
	...
	Stage::Vectortypes::TGLVector LastMousePos;
	Stage::Vectortypes::TGLVector ObjDimensions;
	...
	Stage::Vectortypes::TGLVector __fastcall MouseWorldPos(const int X, const int Y);
...
public:
	...
	void __fastcall UpdateGizmo(const Stage::Vectortypes::TGLVector &NewDimensions)/* overload */;
	void __fastcall SetVisible(const bool AValue);
	Stage::Vectortypes::TGLVector __fastcall GetPickedObjectPoint(Gls::Scene::TGLBaseSceneObject* const Obj);
