...
// (DO NOT EDIT: machine generated header) 'GLS.TerrainRenderer.pas' rev: 36.00 (Windows)
...
protected:
	...
	Gls::Heightdata::TGLHeightData* __fastcall HashedTile(const Stage::Vectorgeometry::TAffineVector &tilePos, bool canAllocate = true)/* overload */;
	...
	Gls::Roampatch::TGLROAMPatch* __fastcall GetPreparedPatch(const Stage::Vectorgeometry::TAffineVector &TilePos, const Stage::Vectorgeometry::TAffineVector &EyePos, float TexFactor, System::Classes::TList* HDList);
...
public:
	...
	float __fastcall InterpolatedHeight(const Stage::Vectortypes::TGLVector &p)/* overload */;
