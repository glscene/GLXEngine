...
// (DO NOT EDIT: machine generated header) 'GXScene_DTRT.dpk' rev: 36.00 (Windows)

#ifndef GXScene_DTRTHPP
#define GXScene_DTRTHPP
...
#include <SysInit.hpp>
#include <GXS.SailSurface.hpp>
#include <GXS.OceanWaves.hpp>
...
namespace Gxscene_dtrt
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Gxscene_dtrt */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GXSCENE_DTRT)
using namespace Gxscene_dtrt;
#endif
#pragma pack(pop)
#pragma option pop
