...
// (DO NOT EDIT: machine generated header) 'GXSL.ShaderParameter.pas' rev: 36.00 (Windows)

#ifndef GXSL_ShaderParameterHPP
#define GXSL_ShaderParameterHPP
...
enum DECLSPEC_DENUM TGXSLInTypes : unsigned char { gsInPoints, gsInLines, gsInAdjLines, gsInTriangles, gsInAdjTriangles };

enum DECLSPEC_DENUM TGXSLOutTypes : unsigned char { gsOutPoints, gsOutLineStrip, sOutTriangleStrip };
...
__interface IShaderParameter  : public System::IInterface 
{
	...
	virtual void __fastcall SetFloatArray(const Stage::Opengltokens::PGLfloat Values, int Count) = 0 ;
	virtual void __fastcall SetIntArray(const Stage::Opengltokens::PGLint Values, int Count) = 0 ;
	virtual void __fastcall SetUIntArray(const Stage::Opengltokens::PGLuint Values, int Count) = 0 ;
...
typedef System::StaticArray<System::AnsiString, 17> Gxsl_Shaderparameter__1;

typedef System::StaticArray<System::AnsiString, 37> Gxsl_Shaderparameter__2;

typedef void __fastcall (__closure *TUniformAutoSetMethod)(_di_IShaderParameter Sender, Gxs::Rendercontextinfo::TgxRenderContextInfo &ARci);

//-- var, const, procedure ---------------------------------------------------
extern DELPHI_PACKAGE Gxsl_Shaderparameter__1 cGXSLTypeString;
extern DELPHI_PACKAGE Gxsl_Shaderparameter__2 cGXSLSamplerString;
...
extern DELPHI_PACKAGE unsigned __fastcall GLSLTypeEnum(TGXSLDataType AType);
extern DELPHI_PACKAGE int __fastcall GLSLTypeComponentCount(TGXSLDataType AType);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GXSL_SHADERPARAMETER)
using namespace Gxsl::Shaderparameter;
#endif
