...
// (DO NOT EDIT: machine generated header) 'GLS.RandomHDS.pas' rev: 36.00 (Windows)
...
typedef System::DynamicArray<Stage::Vectortypes::TVector4f> Gls_Randomhds__2;

typedef System::DynamicArray<System::DynamicArray<Stage::Vectortypes::TVector4f> > TMapOfVector;

typedef Gls::Color::TGLColorVector __fastcall (__closure *TOnDrawTexture)(TGLBaseRandomHDS* const Sender, int x, int y, double z, const Stage::Vectortypes::TGLVector &Normal);
...
protected:
	...
	bool FLighting;
	Stage::Vectortypes::TGLVector FLightDirection;
	Gls::Terrainrenderer::TGLTerrainRenderer* FTerrainRenderer;
	Gls::Color::TGLColorVector FLightColor;
	bool FShadows;
	bool FSea;
	float FSeaLevel;
	float FAmbientLight;
	...
	Gls::Color::TGLColorVector __fastcall OnDrawTextureDefault(TGLBaseRandomHDS* const Sender, int x, int y, double z, const Stage::Vectortypes::TGLVector &Normal);
	...
	void __fastcall SetLightDirection(const Stage::Vectortypes::TGLVector &Value);
	virtual void __fastcall SetTerrainRenderer(Gls::Terrainrenderer::TGLTerrainRenderer* const Value) = 0 ;
	void __fastcall SetLightColor(const Gls::Color::TGLColorVector &Value);
...
public:
	...
	__property Gls::Color::TGLColorVector LightColor = {read=FLightColor, write=SetLightColor};
	__property Stage::Vectortypes::TGLVector LightDirection = {read=FLightDirection, write=SetLightDirection};
...
public:
	...
	void __fastcall BuildLightMap(const Stage::Vectortypes::TGLVector &aLightDirection)/* overload */;
	...
	Stage::Vectortypes::TGLVector __fastcall Normal(const Stage::Vectortypes::TGLVector &Position);
	__property float RangeHeight = {read=FRangeHeight};
	Gls::Coordinates::TGLCoordinates* __fastcall Scale();
...
protected:
	...
	void __fastcall PrepareLandTileData(Gls::Heightdata::TGLHeightData* HeightData, TGLLandTile* LandTile);
	virtual void __fastcall SetTerrainRenderer(Gls::Terrainrenderer::TGLTerrainRenderer* const Value);
...
extern DELPHI_PACKAGE Gls::Color::TGLColorVector __fastcall NoisyColor(const System::Uitypes::TColor Color, const float Noise = 5.000000E-02f);
extern DELPHI_PACKAGE Gls::Color::TGLColorVector __fastcall TextureSand(const int x, const int y);
extern DELPHI_PACKAGE Gls::Color::TGLColorVector __fastcall TextureBrownSoil(const int x, const int y);
extern DELPHI_PACKAGE Gls::Color::TGLColorVector __fastcall TextureDarkGreen(const int x, const int y);
extern DELPHI_PACKAGE Gls::Color::TGLColorVector __fastcall TextureDarkGray(const int x, const int y);
extern DELPHI_PACKAGE Gls::Color::TGLColorVector __fastcall TextureWhite(const int x, const int y);
extern DELPHI_PACKAGE Gls::Color::TGLColorVector __fastcall TextureBlue(const int x, const int y);
extern DELPHI_PACKAGE Gls::Color::TGLColorVector __fastcall TextureGreen(const int x, const int y);
