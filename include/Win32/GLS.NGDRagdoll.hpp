...
// (DO NOT EDIT: machine generated header) 'GLS.NGDRagdoll.pas' rev: 36.00 (Windows)

#ifndef GLS_NGDRagdollHPP
#define GLS_NGDRagdollHPP
...
private:
	...
	public:
		System::Byte kind;
		Stage::Vectortypes::TGLMatrix Mat;
...
public:
	...
	__fastcall TNewtonRagdoll(Gls::Vectorfileobjects::TGLActor* model, Ngd::Import::PNewtonWorld world, float min_env_size, float slide_limit, float erp_, float angle_limit, bool full);
	...
	Stage::Vectortypes::TGLVector __fastcall TranslatePos(int n, bool add);
};
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLS_NGDRAGDOLL)
using namespace Gls::Ngdragdoll;
#endif
