...
// (DO NOT EDIT: machine generated header) 'GLS.FBORenderer.pas' rev: 36.00 (Windows)
...
protected:
	void __fastcall AttachTexture(const unsigned attachment, const unsigned textarget, const unsigned texture, const Stage::Opengltokens::TGLint level, const Stage::Opengltokens::TGLint layer)/* overload */;
...
private:
	...
	Gls::Material::TGLLibMaterialName FColorTextureName;
	Gls::Material::TGLLibMaterialName FDepthTextureName;
	int FWidth;
	int FHeight;
	...
	void __fastcall SetDepthTextureName(const Gls::Material::TGLLibMaterialName Value);
	void __fastcall SetColorTextureName(const Gls::Material::TGLLibMaterialName Value);
...
__published:
	...
	__property Gls::Material::TGLLibMaterialName ColorTextureName = {read=FColorTextureName, write=SetColorTextureName};
	__property Gls::Material::TGLLibMaterialName DepthTextureName = {read=FDepthTextureName, write=SetDepthTextureName};
