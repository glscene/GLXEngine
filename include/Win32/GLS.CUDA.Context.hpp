...
// (DO NOT EDIT: machine generated header) 'GLS.CUDA.Context.pas' rev: 36.00 (Windows)

#ifndef GLS_CUDA_ContextHPP
#define GLS_CUDA_ContextHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLS_CUDA_CONTEXT)
using namespace Gls::Cuda::Context;
#endif
