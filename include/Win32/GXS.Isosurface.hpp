...
// (DO NOT EDIT: machine generated header) 'GXS.Isosurface.pas' rev: 36.00 (Windows)

#ifndef GXS_IsosurfaceHPP
#define GXS_IsosurfaceHPP
...
class DELPHICLASS TgxMarchingCube;
class DELPHICLASS TIsoSurfaceExtractor;
//-- type declarations -------------------------------------------------------
class PASCALIMPLEMENTATION TgxMarchingCube : public System::TObject
{
...
public:
	...
	__fastcall virtual TgxMarchingCube()/* overload */;
	__fastcall virtual TgxMarchingCube(int SizeX, int SizeY, int SizeZ, Stage::Vectortypesext::TScalarValue AIsoValue, float xMin, float xMax, float yMin, float yMax, float zMin, float zMax)/* overload */;
	...
	__fastcall virtual ~TgxMarchingCube();
	...
	void __fastcall CalcVertices(Gxs::Mesh::TgxVertexList* Vertices, float Alpha = 1.000000E+00f);
	void __fastcall CalcMeshObject(Gxs::Vectorfileobjects::TgxMeshObject* AMeshObject, float Alpha = 1.000000E+00f);
...
public:
	...
	__fastcall TIsoSurfaceExtractor(int Xdim, int Ydim, int Zdim, Stage::Vectortypesext::TArray3DExt &AData)/* overload */;
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GXS_ISOSURFACE)
using namespace Gxs::Isosurface;
#endif
