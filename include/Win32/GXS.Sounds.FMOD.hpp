...
// (DO NOT EDIT: machine generated header) 'GXS.Sounds.FMOD.pas' rev: 36.00 (Windows)

#ifndef GXS_Sounds_FMODHPP
#define GXS_Sounds_FMODHPP
...
extern DELPHI_PACKAGE System::WideChar * __stdcall (*FSOUND_GetDriverName)(int Id);
...
extern DELPHI_PACKAGE int __stdcall (*FSOUND_GetSpeakerMode)(void);
...
extern DELPHI_PACKAGE void * __stdcall (*FSOUND_Sample_Load)(int Index, const System::WideChar * NameOrData, unsigned Mode, int Offset, int Length);
...
extern DELPHI_PACKAGE System::WideChar * __stdcall (*FSOUND_Sample_GetName)(Fmod::Types::PFSoundSample Sptr);
...
extern DELPHI_PACKAGE System::ByteBool __stdcall (*FSOUND_Sample_GetDefaultsEx)(Fmod::Types::PFSoundSample Sptr, int &DefFreq, int &DefVol, int &DefPan, int &DefPri, int &VarFreq, int &VarVol, void *VarPan);
...
extern DELPHI_PACKAGE void * __stdcall (*FSOUND_Stream_Open)(const System::WideChar * name_or_data, unsigned Mode, int Offset, int Length);
extern DELPHI_PACKAGE void * __stdcall (*FSOUND_Stream_Create)(Fmod::Types::TFSoundStreamCallback Callback, int Length, unsigned Mode, int SampleRate, int UserData);
...
extern DELPHI_PACKAGE void * __stdcall (*FSOUND_Stream_GetSample)(Fmod::Types::PFSoundStream Stream);
extern DELPHI_PACKAGE void * __stdcall (*FSOUND_Stream_CreateDSP)(Fmod::Types::PFSoundStream Stream, Fmod::Types::TFSoundDSPCallback Callback, int Priority, int Param);
...
extern DELPHI_PACKAGE void * __stdcall (*FSOUND_Stream_AddSyncPoint)(Fmod::Types::PFSoundStream Stream, unsigned PCMOffset, System::WideChar * Name);
...
extern DELPHI_PACKAGE void * __stdcall (*FSOUND_Stream_GetSyncPoint)(Fmod::Types::PFSoundStream Stream, int Index);
extern DELPHI_PACKAGE int __stdcall (*FSOUND_Stream_GetSyncPointInfo)(Fmod::Types::PFSyncPoint Point, unsigned &PCMOffset);
...
extern DELPHI_PACKAGE System::ByteBool __stdcall (*FSOUND_Stream_GetTagField)(Fmod::Types::PFSoundStream Stream, int Num, Fmod::Types::TFSoundTagFieldType &_Type, System::WideChar * &Name, void * &Value, int &Length);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*FSOUND_Stream_FindTagField)(Fmod::Types::PFSoundStream Stream, Fmod::Types::TFSoundTagFieldType _Type, System::WideChar * Name, void * &Value, int &Length);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*FSOUND_Stream_Net_SetProxy)(System::WideChar * Proxy);
extern DELPHI_PACKAGE System::WideChar * __stdcall (*FSOUND_Stream_Net_GetLastServerStatus)(void);
...
extern DELPHI_PACKAGE void * __stdcall (*FSOUND_DSP_Create)(Fmod::Types::TFSoundDSPCallback Callback, int Priority, int Param);
...
extern DELPHI_PACKAGE System::ByteBool __stdcall (*FSOUND_Reverb_SetProperties)(const Fmod::Types::TFSoundReverbProperties &Prop);
...
extern DELPHI_PACKAGE System::WideChar * __stdcall (*FSOUND_Record_GetDriverName)(int Id);
...
extern DELPHI_PACKAGE void * __stdcall (*FMUSIC_LoadSong)(const System::WideChar * Name);
...
extern DELPHI_PACKAGE System::WideChar * __stdcall (*FMUSIC_GetName)(Fmod::Types::PFMusicModule Module);
...
extern DELPHI_PACKAGE void * __stdcall (*FMUSIC_GetSample)(Fmod::Types::PFMusicModule Module, int SampNo);
...
extern DELPHI_PACKAGE bool __fastcall FMOD_Load(System::WideChar * LibName = (System::WideChar *)(0x0));
extern DELPHI_PACKAGE void __fastcall FMOD_Unload(void);
}	/* namespace Fmod */
}	/* namespace Sounds */
}	/* namespace Gxs */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GXS_SOUNDS_FMOD)
using namespace Gxs::Sounds::Fmod;
#endif
