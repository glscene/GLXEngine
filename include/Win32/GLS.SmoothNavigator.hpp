...
// (DO NOT EDIT: machine generated header) 'GLS.SmoothNavigator.pas' rev: 36.00 (Windows)
...
typedef Stage::Vectortypes::TGLVector __fastcall (__closure *TGLNavigatorSmoothChangeVectorGetEvent)(TGLNavigatorSmoothChangeVector* const ASender);

typedef void __fastcall (__closure *TGLNavigatorSmoothChangeVectorSetEvent)(TGLNavigatorSmoothChangeVector* const ASender, const Stage::Vectortypes::TGLVector &AValue);
...
private:
	Gls::Coordinates::TGLCoordinates* FTargetValue;
	TGLNavigatorSmoothChangeVectorGetEvent FOnGetCurrentValue;
	TGLNavigatorSmoothChangeVectorSetEvent FOnSetCurrentValue;
	void __fastcall SetTargetValue(Gls::Coordinates::TGLCoordinates* const Value);
...
__published:
	__property Gls::Coordinates::TGLCoordinates* TargetValue = {read=FTargetValue, write=SetTargetValue};
...
public:
	...
	bool __fastcall AdjustDistanceToPoint(const Stage::Vectortypes::TGLVector &APoint, const float DistanceRatio, double ADeltaTime);
	bool __fastcall AdjustDistanceToTarget(const float DistanceRatio, const double ADeltaTime);
	bool __fastcall AdjustDistanceToPointEx(const Stage::Vectortypes::TGLVector &APoint, double ADeltaTime);
