...
// (DO NOT EDIT: machine generated header) 'Stage.VectorTypesExt.pas' rev: 36.00 (Windows)

#ifndef Stage_VectorTypesExtHPP
#define Stage_VectorTypesExtHPP
...
typedef System::DynamicArray<Stage::Vectortypes::TVector3f> TVertexArray;

typedef System::DynamicArray<double> TDoubleArray;

typedef System::DynamicArray<System::Extended> TVectorExt;

typedef System::DynamicArray<System::Extended> Stage_Vectortypesext__1;

typedef System::DynamicArray<System::DynamicArray<System::Extended> > TMatrixExt;

typedef System::DynamicArray<System::Extended> Stage_Vectortypesext__2;

typedef System::DynamicArray<System::DynamicArray<System::Extended> > Stage_Vectortypesext__3;
...
typedef System::Extended TScalarValue;

typedef TScalarValue __fastcall (*TScalarField)(System::Extended X, System::Extended Y, System::Extended Z);

typedef TScalarValue __fastcall (__closure *TScalarFieldInt)(int iX, int iY, int iZ);

struct DECLSPEC_DRECORD TVertexRec
{
public:
	Stage::Vectortypes::TVector3f P;
	Stage::Vectortypes::TVector3f N;
...
public:
	...
	Stage::Vectortypes::TVector3f V1;
	Stage::Vectortypes::TVector3f V2;
	Stage::Vectortypes::TVector3f V3;
...
public:
	...
	Stage::Vectortypes::TVector3d __fastcall CrossProduct(const Stage::Vectortypes::TVector3d &AVector3D);
	float __fastcall DotProduct(const Stage::Vectortypes::TVector3d &AVector3D);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_STAGE_VECTORTYPESEXT)
using namespace Stage::Vectortypesext;
#endif
