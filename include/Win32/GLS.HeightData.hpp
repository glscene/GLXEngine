...
// (DO NOT EDIT: machine generated header) 'GLS.HeightData.pas' rev: 36.00 (Windows)
...
typedef System::StaticArray<Stage::Vectorgeometry::PByteVector, 268435456> TByteRaster;
...
typedef System::StaticArray<Stage::Vectorgeometry::PFloatVector, 268435456> TSingleRaster;
...
public:
	...
	Stage::Vectorgeometry::TAffineVector __fastcall Normal(int x, int y, const Stage::Vectorgeometry::TAffineVector &scale);
	Stage::Vectorgeometry::TAffineVector __fastcall NormalAtNode(int x, int y, const Stage::Vectorgeometry::TAffineVector &scale);
...
private:
	typedef System::DynamicArray<Stage::Vectorgeometry::PByteVector> _TGLBitmapHDS__1;
