...
// (DO NOT EDIT: machine generated header) 'GLS.CgShader.pas' rev: 36.00 (Windows)

#ifndef GLS_CgShaderHPP
#define GLS_CgShaderHPP
...
public:
	...
	/* Exception.CreateFmt */ inline __fastcall ECgShaderException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High) : Gls::Texture::EGLShaderException(Msg, Args, Args_High) { }
	/* Exception.CreateRes */ inline __fastcall ECgShaderException(System::NativeUInt Ident)/* overload */ : Gls::Texture::EGLShaderException(Ident) { }
	...
	/* Exception.CreateResFmt */ inline __fastcall ECgShaderException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Gls::Texture::EGLShaderException(Ident, Args, Args_High) { }
	/* Exception.CreateResFmt */ inline __fastcall ECgShaderException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High)/* overload */ : Gls::Texture::EGLShaderException(ResStringRec, Args, Args_High) { }
	...
	/* Exception.CreateFmtHelp */ inline __fastcall ECgShaderException(const System::UnicodeString Msg, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext) : Gls::Texture::EGLShaderException(Msg, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResHelp */ inline __fastcall ECgShaderException(System::NativeUInt Ident, int AHelpContext)/* overload */ : Gls::Texture::EGLShaderException(Ident, AHelpContext) { }
	...
	/* Exception.CreateResFmtHelp */ inline __fastcall ECgShaderException(System::PResStringRec ResStringRec, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Gls::Texture::EGLShaderException(ResStringRec, Args, Args_High, AHelpContext) { }
	/* Exception.CreateResFmtHelp */ inline __fastcall ECgShaderException(System::NativeUInt Ident, const System::TVarRec *Args, const System::NativeInt Args_High, int AHelpContext)/* overload */ : Gls::Texture::EGLShaderException(Ident, Args, Args_High, AHelpContext) { }
...
public:
	...
	__property Stage::Vectortypes::TGLVector AsVector = {write=SetAsVector4f};
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLS_CGSHADER)
using namespace Gls::Cgshader;
#endif
