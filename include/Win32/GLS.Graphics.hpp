...
// (DO NOT EDIT: machine generated header) 'GLS.Graphics.pas' rev: 36.00 (Windows)
...
public:
	...
	virtual bool __fastcall AssignFromTexture(Gls::Context::TGLTextureHandle* AHandle, const bool CastToFormat, const Stage::Textureformat::TglInternalFormat intFormat = (Stage::Textureformat::TglInternalFormat)(0x1f), const unsigned colorFormat = (unsigned)(0x0), const unsigned dataType = (unsigned)(0x0));
