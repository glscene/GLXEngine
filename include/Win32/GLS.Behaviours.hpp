...
// (DO NOT EDIT: machine generated header) 'GLS.Behaviours.pas' rev: 36.00 (Windows)
...
public:
	...
	void __fastcall ApplyTranslationAcceleration(const double deltaTime, const Stage::Vectortypes::TGLVector &accel);
	void __fastcall ApplyForce(const double deltaTime, const Stage::Vectortypes::TGLVector &Force);
...
__published:
	__property Gls::Coordinates::TGLCoordinates* Acceleration = {read=FAcceleration, write=FAcceleration};
};
