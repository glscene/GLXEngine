...
// (DO NOT EDIT: machine generated header) 'GLS.OpenGLAdapter.pas' rev: 36.00 (Windows)
...
public:
	...
	int __stdcall (*VDPAURegisterVideoSurfaceNV)(const void * vdpSurface, unsigned target, Stage::Opengltokens::TGLsizei numTextureNames, const Stage::Opengltokens::PGLuint textureNames);
	int __stdcall (*VDPAURegisterOutputSurfaceNV)(const void * vdpSurface, unsigned target, Stage::Opengltokens::TGLsizei numTextureNames, const Stage::Opengltokens::PGLuint textureNames);
