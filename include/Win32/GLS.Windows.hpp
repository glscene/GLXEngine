...
// (DO NOT EDIT: machine generated header) 'GLS.Windows.pas' rev: 36.00 (Windows)
...
private:
	...
	Gls::Gui::TGLGuiComponentName FGuiLayoutName;
	Gls::Gui::TGLGuiComponent* FGuiComponent;
	bool FReBuildGui;
	bool FRedrawAtOnce;
	Stage::Opengltokens::TGLfloat MoveX;
	Stage::Opengltokens::TGLfloat MoveY;
...
protected:
	...
	void __fastcall SetGuiLayoutName(const Gls::Gui::TGLGuiComponentName NewName);
...
__published:
	...
	__property Gls::Gui::TGLGuiComponentName GuiLayoutName = {read=FGuiLayoutName, write=SetGuiLayoutName};
...
private:
	...
	Gls::Color::TGLColorVector FDefaultColor;
...
protected:
	...
	void __fastcall WriteTextAt(Gls::Rendercontextinfo::TGLRenderContextInfo &rci, const Stage::Opengltokens::TGLfloat X, const Stage::Opengltokens::TGLfloat Y, const System::UnicodeString Data, const Gls::Color::TGLColorVector &Color)/* overload */;
	void __fastcall WriteTextAt(Gls::Rendercontextinfo::TGLRenderContextInfo &rci, const Stage::Opengltokens::TGLfloat X1, const Stage::Opengltokens::TGLfloat Y1, const Stage::Opengltokens::TGLfloat X2, const Stage::Opengltokens::TGLfloat Y2, const System::UnicodeString Data, const Gls::Color::TGLColorVector &Color)/* overload */;
...
private:
	...
	Gls::Color::TGLColorVector FFocusedColor;
...
private:
	...
	int OldX;
	int OldY;
	Gls::Color::TGLColorVector FTitleColor;
	float FTitleOffset;
...
private:
	...
	Gls::Gui::TGLGuiComponentName FGuiLayoutNameChecked;
...
protected:
	...
	virtual void __fastcall InternalMouseDown(System::Classes::TShiftState Shift, System::Uitypes::TMouseButton Button, int X, int Y);
	virtual void __fastcall InternalMouseUp(System::Classes::TShiftState Shift, System::Uitypes::TMouseButton Button, int X, int Y);
	void __fastcall SetGuiLayoutNameChecked(const Gls::Gui::TGLGuiComponentName newName);
	virtual void __fastcall SetGuiLayout(Gls::Gui::TGLGuiLayout* NewGui);
...
__published:
	...
	__property Gls::Gui::TGLGuiComponentName GuiLayoutNameChecked = {read=FGuiLayoutNameChecked, write=SetGuiLayoutNameChecked};
public:
...
private:
	...
	Gls::Gui::TGLGuiComponentName FGuiLayoutNamePressed;
...
protected:
	...
	virtual void __fastcall InternalKeyUp(System::Word &Key, System::Classes::TShiftState Shift);
	virtual void __fastcall SetFocused(bool Value);
	void __fastcall SetGuiLayoutNamePressed(const Gls::Gui::TGLGuiComponentName newName);
	virtual void __fastcall SetGuiLayout(Gls::Gui::TGLGuiLayout* NewGui);
...
__published:
	...
	__property Gls::Gui::TGLGuiComponentName GuiLayoutNamePressed = {read=FGuiLayoutNamePressed, write=SetGuiLayoutNamePressed};
...
private:
	...
	float FPageSize;
	System::Classes::TNotifyEvent FOnChange;
	Gls::Gui::TGLGuiComponentName FGuiLayoutKnobName;
...
protected:
	...
	void __fastcall SetGuiLayoutKnobName(const Gls::Gui::TGLGuiComponentName newName);
	virtual void __fastcall SetGuiLayout(Gls::Gui::TGLGuiLayout* NewGui);
...
__published:
	...
	__property System::Classes::TNotifyEvent OnChange = {read=FOnChange, write=FOnChange};
	__property Gls::Gui::TGLGuiComponentName GuiLayoutKnobName = {read=FGuiLayoutKnobName, write=SetGuiLayoutKnobName};
...
private:
	...
	Gls::Color::TGLColorVector FHeaderColor;
	int FMarginSize;
	int FColumnSize;
	int FRowHeight;
