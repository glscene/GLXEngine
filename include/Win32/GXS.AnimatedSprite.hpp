...
__published:
	__property System::NativeInt CurrentFrame = {read=FCurrentFrame, write=SetCurrentFrame, nodefault};
	__property System::NativeInt StartFrame = {read=FStartFrame, write=FStartFrame, nodefault};
	__property System::NativeInt EndFrame = {read=FEndFrame, write=FEndFrame, nodefault};
	__property System::NativeInt FrameWidth = {read=FFrameWidth, write=SetFrameWidth, nodefault};
	__property System::NativeInt FrameHeight = {read=FFrameHeight, write=SetFrameHeight, nodefault};
	...
	__property System::NativeInt Interval = {read=FInterval, write=SetInterval, nodefault};
