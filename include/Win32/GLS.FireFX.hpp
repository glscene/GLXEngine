...
// (DO NOT EDIT: machine generated header) 'GLS.FireFX.pas' rev: 36.00 (Windows)
...
public:
	...
	Stage::Vectortypes::TGLVector Speed;
	float Alpha;
	float TimeToLive;
	float LifeLength;
};
...
private:
	...
	PGLFireParticleArray FFireParticles;
	Gls::Coordinates::TGLCoordinates* FFireDir;
	Gls::Coordinates::TGLCoordinates* FInitialDir;
...
protected:
	...
	void __fastcall SetFireDir(Gls::Coordinates::TGLCoordinates* const val);
	void __fastcall SetInitialDir(Gls::Coordinates::TGLCoordinates* const val);
	...
	void __fastcall AffParticle3d(const Gls::Color::TGLColorVector &Color2, const Stage::Vectortypes::TGLMatrix &mat);
...
__published:
	__property Gls::Coordinates::TGLCoordinates* FireDir = {read=FFireDir, write=SetFireDir};
	__property Gls::Coordinates::TGLCoordinates* InitialDir = {read=FInitialDir, write=SetInitialDir};
