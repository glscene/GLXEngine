...
// (DO NOT EDIT: machine generated header) 'GLS.SoundManager.pas' rev: 36.00 (Windows)
...
private:
	...
	Stage::Vectortypes::TGLVector FLastListenerPosition;
...
protected:
	...
	virtual void __fastcall DefineProperties(System::Classes::TFiler* Filer);
	void __fastcall ListenerCoordinates(Stage::Vectortypes::TGLVector &position, Stage::Vectortypes::TGLVector &velocity, Stage::Vectortypes::TGLVector &direction, Stage::Vectortypes::TGLVector &up);
