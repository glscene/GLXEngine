...
// (DO NOT EDIT: machine generated header) 'GLS.Blur.pas' rev: 36.00 (Windows)
...
{
public:
	Stage::Opengltokens::TGLubyte R;
	Stage::Opengltokens::TGLubyte G;
	Stage::Opengltokens::TGLubyte B;
};
