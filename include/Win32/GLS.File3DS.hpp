...
// (DO NOT EDIT: machine generated header) 'GLS.File3DS.pas' rev: 36.00 (Windows)
...
{
public:
	Stage::Vectortypes::TGLMatrix ModelMatrix;
...
protected:
	...
	Stage::Vectortypes::TGLMatrix __fastcall InterpolateValue(const Formats::M3dstypes::TKFRotKey3DS *AValues, const System::NativeInt AValues_High, const double AFrame)/* overload */;
...
private:
	typedef System::DynamicArray<Stage::Vectortypes::TVector3f> _TGLFile3DSScaleAnimationKeys__1;
...
private:
	typedef System::DynamicArray<Stage::Vectortypes::TVector3f> _TGLFile3DSPositionAnimationKeys__1;
...
private:
	typedef System::DynamicArray<Stage::Vectortypes::TVector3f> _TGLFile3DSColorAnimationKeys__1;
...
private:
	typedef System::DynamicArray<Stage::Vectortypes::TVector3f> _TTGLFile3DSPositionAnimationKeys__1;
