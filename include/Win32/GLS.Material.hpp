...
// (DO NOT EDIT: machine generated header) 'GLS.Material.pas' rev: 36.00 (Windows)
...
protected:
	...
	void __fastcall SetCompareFunc(Gls::Texture::TGLDepthCompareFunc Value);
...
__published:
	...
	__property Gls::State::TGLDepthFunction DepthCompareFunction = {read=FCompareFunc, write=SetCompareFunc, default=3};
...
protected:
	...
	void __fastcall SetTextureOffset(Gls::Coordinates::TGLCoordinates* const val);
	void __fastcall SetTextureScale(Gls::Coordinates::TGLCoordinates* const val);
	void __fastcall SetTextureMatrix(const Stage::Vectortypes::TGLMatrix &Value);
...
__published:
	...
	__property Gls::Coordinates::TGLCoordinates* TextureOffset = {read=FTextureOffset, write=SetTextureOffset};
	__property Gls::Coordinates::TGLCoordinates* TextureScale = {read=FTextureScale, write=SetTextureScale};
...
public:
	...
	TGLLibMaterialName __fastcall GetNameOfTexture(Gls::Texture::TGLTexture* const Texture);
...
public:
	...
	Gls::Texture::TGLTexture* __fastcall TextureByName(const TGLLibMaterialName LibMatName);
	TGLLibMaterialName __fastcall GetNameOfTexture(Gls::Texture::TGLTexture* const Texture);
