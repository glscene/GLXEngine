...
// (DO NOT EDIT: machine generated header) 'Stage.VectorTypes.pas' rev: 36.00 (Windows)

#ifndef Stage_VectorTypesHPP
#define Stage_VectorTypesHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_STAGE_VECTORTYPES)
using namespace Stage::Vectortypes;
#endif
