...
// (DO NOT EDIT: machine generated header) 'GLS.PersistentClasses.pas' rev: 36.00 (Windows)
...
typedef System::TMetaClass* TGLVirtualReaderClass;

typedef System::TMetaClass* TGLVirtualWriterClass;
...
public:
	...
	__classmethod virtual TGLVirtualWriterClass __fastcall FileVirtualWriter();
	__classmethod virtual TGLVirtualReaderClass __fastcall FileVirtualReader();
	...
	DYNAMIC void __fastcall SaveToStream(System::Classes::TStream* stream, TGLVirtualWriterClass writerClass = 0x0);
	DYNAMIC void __fastcall LoadFromStream(System::Classes::TStream* stream, TGLVirtualReaderClass readerClass = 0x0);
	DYNAMIC void __fastcall SaveToFile(const System::UnicodeString fileName, TGLVirtualWriterClass writerClass = 0x0);
	DYNAMIC void __fastcall LoadFromFile(const System::UnicodeString fileName, TGLVirtualReaderClass readerClass = 0x0);
	DYNAMIC System::UnicodeString __fastcall SaveToString(TGLVirtualWriterClass writerClass = 0x0);
	DYNAMIC void __fastcall LoadFromString(const System::UnicodeString data, TGLVirtualReaderClass readerClass = 0x0);
private:
...
typedef System::TMetaClass* TGLPersistentObjectClass;

typedef System::StaticArray<System::TObject*, 268435456> TGLPointerObjectList;

typedef TGLPointerObjectList *PGLPointerObjectList;

typedef int __fastcall (*TGLObjectListSortCompare)(System::TObject* item1, System::TObject* item2);
...
public:
	...
	void __fastcall Sort(TGLObjectListSortCompare compareFunc);
public:
