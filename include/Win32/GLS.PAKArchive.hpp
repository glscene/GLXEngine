...
// (DO NOT EDIT: machine generated header) 'GLS.PAKArchive.pas' rev: 36.00 (Windows)

#ifndef GLS_PAKArchiveHPP
#define GLS_PAKArchiveHPP
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GLS_PAKARCHIVE)
using namespace Gls::Pakarchive;
#endif
