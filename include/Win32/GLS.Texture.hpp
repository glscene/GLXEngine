...
// (DO NOT EDIT: machine generated header) 'GLS.Texture.pas' rev: 36.00 (Windows)
...
typedef Stage::Textureformat::TglInternalCompression TGLTextureCompression;
...
public:
	...
	void __fastcall ApplyAsTexture2(Gls::Rendercontextinfo::TGLRenderContextInfo &rci, Stage::Vectortypes::PGLMatrix textureMatrix = (Stage::Vectortypes::PGLMatrix)(0x0));
	void __fastcall UnApplyAsTexture2(Gls::Rendercontextinfo::TGLRenderContextInfo &rci, bool reloadIdentityTextureMatrix);
	void __fastcall ApplyAsTextureN(int n, Gls::Rendercontextinfo::TGLRenderContextInfo &rci, Stage::Vectortypes::PGLMatrix textureMatrix = (Stage::Vectortypes::PGLMatrix)(0x0));
...
protected:
	...
	void __fastcall SetTextureOffset(Gls::Coordinates::TGLCoordinates* const Value);
	void __fastcall SetTextureScale(Gls::Coordinates::TGLCoordinates* const Value);
