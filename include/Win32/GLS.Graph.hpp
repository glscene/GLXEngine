...
// (DO NOT EDIT: machine generated header) 'GLS.Graph.pas' rev: 36.00 (Windows)
...
typedef void __fastcall (__closure *TGLHeightFieldGetHeightEvent)(const float x, const float y, float &z, Gls::Color::TGLColorVector &Color, Stage::Vectorgeometry::TTexPoint &TexPoint);

typedef void __fastcall (__closure *TGLHeightFieldGetHeight2Event)(System::TObject* Sender, const float x, const float y, float &z, Gls::Color::TGLColorVector &Color, Stage::Vectorgeometry::TTexPoint &TexPoint);
...
protected:
	...
	void __fastcall DefaultHeightField(const float x, const float y, float &z, Gls::Color::TGLColorVector &Color, Stage::Vectorgeometry::TTexPoint &TexPoint);
	void __fastcall Height2Field(const float x, const float y, float &z, Gls::Color::TGLColorVector &Color, Stage::Vectorgeometry::TTexPoint &texPoint);
