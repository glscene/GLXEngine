...
// (DO NOT EDIT: machine generated header) 'GLS.MaterialEx.pas' rev: 36.00 (Windows)
...
protected:
	bool FEnabled;
	Gls::Material::TGLLibMaterialName FNextPassName;
	TGLLibMaterialEx* __fastcall GetMaterial();
	TGLMaterialLibraryEx* __fastcall GetMaterialLibraryEx();
	virtual void __fastcall SetEnabled(bool AValue);
	void __fastcall SetNextPass(const Gls::Material::TGLLibMaterialName AValue);
	virtual void __fastcall Loaded();
	__property Gls::Material::TGLLibMaterialName NextPass = {read=FNextPassName, write=SetNextPass};
...
private:
	...
	int FLODBias;
	float FLODBiasFract;
	System::StaticArray<Stage::Textureformat::TglSeparateTextureWrap, 3> FWrap;
	Gls::Color::TGLColor* FBorderColor;
	Stage::Textureformat::TglTextureCompareMode FCompareMode;
	Gls::State::TGLDepthFunction FCompareFunc;
	bool FDecodeSRGB;
	...
	void __fastcall SetFilteringQuality(Stage::Textureformat::TglTextureFilteringQuality AValue);
	Stage::Textureformat::TglSeparateTextureWrap __fastcall GetWrap(int Index);
	void __fastcall SetWrap(int Index, Stage::Textureformat::TglSeparateTextureWrap AValue);
	void __fastcall SetBorderColor(Gls::Color::TGLColor* const AValue);
	void __fastcall SetCompareMode(Stage::Textureformat::TglTextureCompareMode AValue);
	void __fastcall SetCompareFunc(Gls::State::TGLDepthFunction AValue);
...
__published:
	...
	__property Stage::Textureformat::TglTextureFilteringQuality FilteringQuality = {read=FFilteringQuality, write=SetFilteringQuality, default=1};
	__property int LodBias = {read=FLODBias, write=SetLODBias, default=0};
	__property Stage::Textureformat::TglSeparateTextureWrap WrapX = {read=GetWrap, write=SetWrap, index=0, default=0};
	__property Stage::Textureformat::TglSeparateTextureWrap WrapY = {read=GetWrap, write=SetWrap, index=1, default=0};
	__property Stage::Textureformat::TglSeparateTextureWrap WrapZ = {read=GetWrap, write=SetWrap, index=2, default=0};
	__property Gls::Color::TGLColor* BorderColor = {read=FBorderColor, write=SetBorderColor};
	__property Stage::Textureformat::TglTextureCompareMode CompareMode = {read=FCompareMode, write=SetCompareMode, default=0};
	__property Gls::State::TGLDepthFunction CompareFunc = {read=FCompareFunc, write=SetCompareFunc, default=3};
...
protected:
	...
	int FHeight;
	int FDepth;
	Stage::Textureformat::TglSwizzleVector FSwizzles;
...
__published:
	__property Stage::Textureformat::TglTextureTarget Shape = {read=GetTextureTarget, nodefault};
public:
...
private:
	Gls::Texture::TGLTextureCompression FCompression;
	...
	int FMaxLevel;
	double FLastTime;
	void __fastcall SetInternalFormat(const Stage::Textureformat::TglInternalFormat AValue);
	...
	void __fastcall SetCompression(const Gls::Texture::TGLTextureCompression AValue);
...
__published:
	...
	__property Stage::Textureformat::TglInternalFormat InternalFormat = {read=FInternalFormat, write=SetInternalFormat, default=31};
	...
	__property Gls::Texture::TGLTextureCompression Compression = {read=FCompression, write=SetCompression, default=0};
...
private:
	Stage::Textureformat::TglSwizzleVector FSwizzles;
	Stage::Textureformat::TglTextureSwizzle __fastcall GetSwizzle(int AIndex);
	void __fastcall SetSwizzle(int AIndex, Stage::Textureformat::TglTextureSwizzle AValue);
...
__published:
	__property Stage::Textureformat::TglTextureSwizzle RedFrom = {read=GetSwizzle, write=SetSwizzle, stored=StoreSwizzle, index=0, nodefault};
	__property Stage::Textureformat::TglTextureSwizzle GreenFrom = {read=GetSwizzle, write=SetSwizzle, stored=StoreSwizzle, index=1, nodefault};
	__property Stage::Textureformat::TglTextureSwizzle BlueFrom = {read=GetSwizzle, write=SetSwizzle, stored=StoreSwizzle, index=2, nodefault};
	__property Stage::Textureformat::TglTextureSwizzle AlphaFrom = {read=GetSwizzle, write=SetSwizzle, stored=StoreSwizzle, index=3, nodefault};
public:
...
private:
	...
	Gls::Coordinates::TGLCoordinates* FTextureOffset;
	Gls::Coordinates::TGLCoordinates* FTextureScale;
	...
	Gls::Coordinates::TGLCoordinates* __fastcall GetTextureOffset();
	void __fastcall SetTextureOffset(Gls::Coordinates::TGLCoordinates* const AValue);
	bool __fastcall StoreTextureOffset();
	Gls::Coordinates::TGLCoordinates* __fastcall GetTextureScale();
	void __fastcall SetTextureScale(Gls::Coordinates::TGLCoordinates* const AValue);
	bool __fastcall StoreTextureScale();
	void __fastcall SetTextureMatrix(const Stage::Vectortypes::TGLMatrix &AValue);
...
public:
	...
	void __fastcall Apply(Gls::Rendercontextinfo::TGLRenderContextInfo &ARci);
	void __fastcall UnApply(Gls::Rendercontextinfo::TGLRenderContextInfo &ARci);
	__property Stage::Vectortypes::TGLMatrix TextureMatrix = {read=FTextureMatrix, write=SetTextureMatrix};
...
__published:
	...
	__property Gls::Coordinates::TGLCoordinates* TextureOffset = {read=GetTextureOffset, write=SetTextureOffset, stored=StoreTextureOffset};
	__property Gls::Coordinates::TGLCoordinates* TextureScale = {read=GetTextureScale, write=SetTextureScale, stored=StoreTextureScale};
...
protected:
	...
	virtual Stage::Textureformat::TglSwizzleVector __fastcall GetTextureSwizzle();
	...
	virtual void __fastcall SetTextureSwizzle(const Stage::Textureformat::TglSwizzleVector AValue);
	virtual float __fastcall GetFloat();
	virtual Stage::Vectortypes::TVector2f __fastcall GetVec2();
	virtual Stage::Vectortypes::TVector3f __fastcall GetVec3();
	virtual Stage::Vectortypes::TGLVector __fastcall GetVec4();
	virtual Stage::Opengltokens::TGLint __fastcall GetInt();
	virtual Stage::Vectortypes::TVector2i __fastcall GetIVec2();
	virtual Stage::Vectortypes::TVector3i __fastcall GetIVec3();
	virtual Stage::Vectortypes::TVector4i __fastcall GetIVec4();
	virtual unsigned __fastcall GetUInt();
	virtual Stage::Vectortypes::TVector2ui __fastcall GetUVec2();
	virtual Stage::Vectortypes::TVector3ui __fastcall GetUVec3();
	virtual Stage::Vectortypes::TVector4ui __fastcall GetUVec4();
	virtual void __fastcall SetFloat(const Stage::Opengltokens::TGLfloat Value);
	virtual void __fastcall SetVec2(const Stage::Vectortypes::TVector2f &Value);
	virtual void __fastcall SetVec3(const Stage::Vectortypes::TVector3f &Value);
	virtual void __fastcall SetVec4(const Stage::Vectortypes::TVector4f &Value);
	virtual void __fastcall SetInt(const int Value);
	virtual void __fastcall SetIVec2(const Stage::Vectortypes::TVector2i &Value);
	virtual void __fastcall SetIVec3(const Stage::Vectortypes::TVector3i &Value);
	virtual void __fastcall SetIVec4(const Stage::Vectortypes::TVector4i &Value);
	virtual void __fastcall SetUInt(const unsigned Value);
	virtual void __fastcall SetUVec2(const Stage::Vectortypes::TVector2ui &Value);
	virtual void __fastcall SetUVec3(const Stage::Vectortypes::TVector3ui &Value);
	virtual void __fastcall SetUVec4(const Stage::Vectortypes::TVector4ui &Value);
	virtual Stage::Vectortypes::TMatrix2f __fastcall GetMat2();
	virtual Stage::Vectortypes::TMatrix3f __fastcall GetMat3();
	virtual Stage::Vectortypes::TMatrix4f __fastcall GetMat4();
	virtual void __fastcall SetMat2(const Stage::Vectortypes::TMatrix2f &Value);
	virtual void __fastcall SetMat3(const Stage::Vectortypes::TMatrix3f &Value);
	virtual void __fastcall SetMat4(const Stage::Vectortypes::TMatrix4f &Value);
	virtual void __fastcall SetFloatArray(const Stage::Opengltokens::PGLfloat Values, int Count);
	virtual void __fastcall SetIntArray(const Stage::Opengltokens::PGLint Values, int Count);
	virtual void __fastcall SetUIntArray(const Stage::Opengltokens::PGLuint Values, int Count);
	virtual void __fastcall WriteToFiler(System::Classes::TWriter* AWriter);
	virtual void __fastcall ReadFromFiler(System::Classes::TReader* AReader);
	virtual void __fastcall Apply(Gls::Rendercontextinfo::TGLRenderContextInfo &ARci);
public:
...
private:
	...
	Stage::Textureformat::TglSwizzleVector FSwizzling;
...
public:
	...
	__property Stage::Textureformat::TglSwizzleVector Swizzling = {read=GetTextureSwizzle, write=SetTextureSwizzle};
};
...
public:
	...
	TGLLibMaterialEx* __fastcall GetLibMaterialByName(const Gls::Material::TGLLibMaterialName AName);
public:
