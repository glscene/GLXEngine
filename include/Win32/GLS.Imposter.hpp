...
// (DO NOT EDIT: machine generated header) 'GLS.Imposter.pas' rev: 36.00 (Windows)
...
protected:
	Stage::Vectortypes::TGLVector FVx;
	Stage::Vectortypes::TGLVector FVy;
	Stage::Vectortypes::TGLVector FStaticOffset;
	...
	void __fastcall RenderQuad(const Stage::Vectortypes::TGLVector &texExtents, const Stage::Vectortypes::TGLVector &objPos, float size);
...
public:
	...
	virtual void __fastcall Render(Gls::Rendercontextinfo::TGLRenderContextInfo &rci, const Stage::Vectortypes::TGLVector &objPos, const Stage::Vectortypes::TGLVector &localCameraPos, float size);
	virtual void __fastcall EndRender(Gls::Rendercontextinfo::TGLRenderContextInfo &rci);
	void __fastcall RenderOnce(Gls::Rendercontextinfo::TGLRenderContextInfo &rci, const Stage::Vectortypes::TGLVector &objPos, const Stage::Vectortypes::TGLVector &localCameraPos, float size);
...
private:
	...
	Gls::Coordinates::TGLCoordinates* FBuildOffset;
...
protected:
	...
	void __fastcall SetBuildOffset(Gls::Coordinates::TGLCoordinates* AValue);
	...
	virtual void __fastcall DoUserSpecifiedImposter(Gls::Rendercontextinfo::TGLRenderContextInfo &rci, TImposter* destImposter, Gls::Graphics::TGLBitmap32* bmp32);
...
__published:
	...
	__property Gls::Coordinates::TGLCoordinates* BuildOffset = {read=FBuildOffset, write=SetBuildOffset};
