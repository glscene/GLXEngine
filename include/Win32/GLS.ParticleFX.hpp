...
// (DO NOT EDIT: machine generated header) 'GLS.ParticleFX.pas' rev: 36.00 (Windows)
...
private:
	Gls::Coordinates::TGLCoordinates* FInitialVelocity;
	Gls::Coordinates::TGLCoordinates* FInitialPosition;
	Gls::Coordinates::TGLCoordinates* FPositionDispersionRange;
...
protected:
	void __fastcall SetInitialVelocity(Gls::Coordinates::TGLCoordinates* const val);
	void __fastcall SetInitialPosition(Gls::Coordinates::TGLCoordinates* const val);
	void __fastcall SetPositionDispersionRange(Gls::Coordinates::TGLCoordinates* const val);
...
__published:
	__property Gls::Coordinates::TGLCoordinates* InitialVelocity = {read=FInitialVelocity, write=SetInitialVelocity};
	__property float VelocityDispersion = {read=FVelocityDispersion, write=FVelocityDispersion};
	__property Gls::Coordinates::TGLCoordinates* InitialPosition = {read=FInitialPosition, write=SetInitialPosition};
	__property float PositionDispersion = {read=FPositionDispersion, write=FPositionDispersion};
	__property Gls::Coordinates::TGLCoordinates* PositionDispersionRange = {read=FPositionDispersionRange, write=SetPositionDispersionRange};
...
private:
	Gls::Coordinates::TGLCoordinates* FAcceleration;
	float FFriction;
	double FCurrentTime;
	
protected:
	void __fastcall SetAcceleration(Gls::Coordinates::TGLCoordinates* const val);
...
__published:
	__property Gls::Coordinates::TGLCoordinates* Acceleration = {read=FAcceleration, write=SetAcceleration};
...
protected:
	...
	void __fastcall ComputeColors(float &lifeTime, Gls::Color::TGLColorVector &inner, Gls::Color::TGLColorVector &outer);
	void __fastcall ComputeInnerColor(float &lifeTime, Gls::Color::TGLColorVector &inner);
	void __fastcall ComputeOuterColor(float &lifeTime, Gls::Color::TGLColorVector &outer);
	...
	void __fastcall RotateVertexBuf(Gls::Vectorlists::TGLAffineVectorList* buf, float lifeTime, const Stage::Vectorgeometry::TAffineVector &axis, float offsetAngle);
...
protected:
	virtual void __fastcall PrepareImage(Gls::Graphics::TGLBitmap32* bmp32, int &texFormat) = 0 ;
...
typedef void __fastcall (__closure *TPFXPrepareTextureImageEvent)(System::TObject* Sender, Gls::Graphics::TGLBitmap32* destBmp32, int &texFormat);
...
protected:
	virtual void __fastcall PrepareImage(Gls::Graphics::TGLBitmap32* bmp32, int &texFormat);
