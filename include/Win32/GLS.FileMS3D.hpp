...
// (DO NOT EDIT: machine generated header) 'GLS.FileMS3D.pas' rev: 36.00 (Windows)
...
public:
	System::StaticArray<char, 32> Name;
	Gls::Color::TGLColorVector Ambient;
	Gls::Color::TGLColorVector Diffuse;
	Gls::Color::TGLColorVector Specular;
	Gls::Color::TGLColorVector Emissive;
	float Shininess;
	float Transparency;
	char Mode;
