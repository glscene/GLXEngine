...
// (DO NOT EDIT: machine generated header) 'GLS.Scene.pas' rev: 36.00 (Windows)
...
typedef System::TMetaClass* TGLEffectClass;
...
private:
	Stage::Vectortypes::TGLMatrix FAbsoluteMatrix;
	Stage::Vectortypes::TGLMatrix FInvAbsoluteMatrix;
	...
	Gls::Coordinates::TGLCoordinates* FScaling;
	...
	int FUpdateCount;
	bool FShowAxes;
	Gls::Coordinates::TGLCoordinates* FRotation;
	bool FIsCalculating;
	...
	void __fastcall SetDirection(Gls::Coordinates::TGLCoordinates* AVector);
	void __fastcall SetUp(Gls::Coordinates::TGLCoordinates* AVector);
	Stage::Vectortypes::PGLMatrix __fastcall GetMatrix();
	void __fastcall SetPosition(Gls::Coordinates::TGLCoordinates* APosition);
	...
	void __fastcall SetRotation(Gls::Coordinates::TGLCoordinates* aRotation);
	...
	void __fastcall SetScaling(Gls::Coordinates::TGLCoordinates* AValue);
	...
	Stage::Vectortypes::TGLVector __fastcall GetAbsoluteScale();
	void __fastcall SetAbsoluteAffineScale(const Stage::Vectorgeometry::TAffineVector &Value);
	void __fastcall SetAbsoluteScale(const Stage::Vectortypes::TGLVector &Value);
	Stage::Vectortypes::TGLMatrix __fastcall GetAbsoluteMatrix();
	void __fastcall SetAbsoluteMatrix(const Stage::Vectortypes::TGLMatrix &Value);
	void __fastcall SetBBChanges(const TGLObjectBBChanges Value);
	Stage::Vectortypes::PGLMatrix __fastcall GetDirectAbsoluteMatrix();
	Stage::Vectortypes::PGLMatrix __fastcall GetLocalMatrix();
...
protected:
	...
	void __fastcall SetAbsolutePosition(const Stage::Vectortypes::TGLVector &v);
	Stage::Vectortypes::TGLVector __fastcall GetAbsolutePosition();
	void __fastcall SetAbsoluteUp(const Stage::Vectortypes::TGLVector &v);
	Stage::Vectortypes::TGLVector __fastcall GetAbsoluteUp();
	void __fastcall SetAbsoluteDirection(const Stage::Vectortypes::TGLVector &v);
	Stage::Vectortypes::TGLVector __fastcall GetAbsoluteDirection();
...
public:
	...
	void __fastcall SetMatrix(const Stage::Vectortypes::TGLMatrix &aValue);
	__property Stage::Vectortypes::PGLMatrix Matrix = {read=GetMatrix};
	__property Stage::Vectortypes::PGLMatrix LocalMatrix = {read=GetLocalMatrix};
	void __fastcall ForceLocalMatrix(const Stage::Vectortypes::TGLMatrix &aMatrix);
	Stage::Vectortypes::PGLMatrix __fastcall AbsoluteMatrixAsAddress();
	__property Stage::Vectortypes::PGLMatrix DirectAbsoluteMatrix = {read=GetDirectAbsoluteMatrix};
	Stage::Vectortypes::TGLMatrix __fastcall InvAbsoluteMatrix();
	Stage::Vectortypes::PGLMatrix __fastcall InvAbsoluteMatrixAsAddress();
	__property Stage::Vectortypes::TGLMatrix AbsoluteMatrix = {read=GetAbsoluteMatrix, write=SetAbsoluteMatrix};
	__property Stage::Vectortypes::TGLVector AbsoluteDirection = {read=GetAbsoluteDirection, write=SetAbsoluteDirection};
	...
	__property Stage::Vectortypes::TGLVector AbsoluteScale = {read=GetAbsoluteScale, write=SetAbsoluteScale};
	...
	__property Stage::Vectortypes::TGLVector AbsoluteUp = {read=GetAbsoluteUp, write=SetAbsoluteUp};
	__property Stage::Vectorgeometry::TAffineVector AbsoluteAffineUp = {read=GetAbsoluteAffineUp, write=SetAbsoluteAffineUp};
	Stage::Vectortypes::TGLVector __fastcall AbsoluteRight();
	Stage::Vectortypes::TGLVector __fastcall AbsoluteLeft();
	__property Stage::Vectortypes::TGLVector AbsolutePosition = {read=GetAbsolutePosition, write=SetAbsolutePosition};
	...
	Stage::Vectortypes::PGLVector __fastcall AbsolutePositionAsAddress();
	Stage::Vectortypes::TGLVector __fastcall AbsoluteXVector();
	Stage::Vectortypes::TGLVector __fastcall AbsoluteYVector();
	Stage::Vectortypes::TGLVector __fastcall AbsoluteZVector();
	Stage::Vectortypes::TGLVector __fastcall AbsoluteToLocal(const Stage::Vectortypes::TGLVector &v)/* overload */;
	Stage::Vectorgeometry::TAffineVector __fastcall AbsoluteToLocal(const Stage::Vectorgeometry::TAffineVector &v)/* overload */;
	Stage::Vectortypes::TGLVector __fastcall LocalToAbsolute(const Stage::Vectortypes::TGLVector &v)/* overload */;
	Stage::Vectorgeometry::TAffineVector __fastcall LocalToAbsolute(const Stage::Vectorgeometry::TAffineVector &v)/* overload */;
	Stage::Vectortypes::TGLVector __fastcall Right();
	Stage::Vectortypes::TGLVector __fastcall LeftVector();
	...
	float __fastcall SqrDistanceTo(const Stage::Vectortypes::TGLVector &pt)/* overload */;
	...
	float __fastcall DistanceTo(const Stage::Vectortypes::TGLVector &pt)/* overload */;
	virtual Stage::Vectortypes::TGLVector __fastcall BarycenterAbsolutePosition();
	float __fastcall BarycenterSqrDistanceTo(const Stage::Vectortypes::TGLVector &pt);
	virtual Stage::Vectortypes::TGLVector __fastcall AxisAlignedDimensions();
	...
	virtual bool __fastcall PointInObject(const Stage::Vectortypes::TGLVector &point);
	...
	void __fastcall PointTo(TGLBaseSceneObject* const ATargetObject, const Stage::Vectortypes::TGLVector &AUpVector)/* overload */;
	void __fastcall PointTo(const Stage::Vectortypes::TGLVector &AAbsolutePosition, const Stage::Vectortypes::TGLVector &AUpVector)/* overload */;
	...
	__property Gls::Coordinates::TGLCoordinates* Rotation = {read=FRotation, write=SetRotation};
	...
	__property Gls::Coordinates::TGLCoordinates* Scale = {read=FScaling, write=SetScaling};
...
private:
	unsigned FLightID;
	Gls::Coordinates::TGLCoordinates* FSpotDirection;
	float FSpotExponent;
	float FSpotCutOff;
...
protected:
	...
	void __fastcall SetSpotDirection(Gls::Coordinates::TGLCoordinates* AVector);
...
__published:
	...
	__property Gls::Coordinates::TGLCoordinates* SpotDirection = {read=FSpotDirection, write=SetSpotDirection};
...
typedef void __fastcall (__closure *TOnCustomPerspective)(const Stage::Vectorgeometry::TRectangle &viewport, int width, int height, int DPI, float &viewPortRadius);
...
private:
	...
	Stage::Vectortypes::TGLVector FLastDirection;
...
public:
	...
	Stage::Vectortypes::TGLVector __fastcall AbsoluteEyeSpaceVector(float forwardDistance, float rightDistance, float upDistance);
	void __fastcall AdjustDistanceToTarget(float distanceRatio);
	float __fastcall DistanceToTarget();
	Stage::Vectortypes::TGLVector __fastcall AbsoluteVectorToTarget();
	Stage::Vectortypes::TGLVector __fastcall AbsoluteRightVectorToTarget();
	Stage::Vectortypes::TGLVector __fastcall AbsoluteUpVectorToTarget();
	Stage::Vectortypes::TGLVector __fastcall ScreenDeltaToVector(int deltaX, int deltaY, float ratio, const Stage::Vectortypes::TGLVector &planeNormal);
	Stage::Vectortypes::TGLVector __fastcall ScreenDeltaToVectorXY(int deltaX, int deltaY, float ratio);
	Stage::Vectortypes::TGLVector __fastcall ScreenDeltaToVectorXZ(int deltaX, int deltaY, float ratio);
	Stage::Vectortypes::TGLVector __fastcall ScreenDeltaToVectorYZ(int deltaX, int deltaY, float ratio);
	bool __fastcall PointInFront(const Stage::Vectortypes::TGLVector &point)/* overload */;
...
public:
	...
	TGLBaseSceneObject* __fastcall RayCastIntersect(const Stage::Vectortypes::TGLVector &rayStart, const Stage::Vectortypes::TGLVector &rayVector, Stage::Vectortypes::PGLVector intersectPoint = (Stage::Vectortypes::PGLVector)(0x0), Stage::Vectortypes::PGLVector intersectNormal = (Stage::Vectortypes::PGLVector)(0x0));
...
private:
	typedef System::DynamicArray<Stage::Vectortypes::TMatrix4f> _TGLSceneBuffer__1;
	
	typedef System::DynamicArray<Stage::Vectortypes::TMatrix4f> _TGLSceneBuffer__2;
...
private:
	...
	Stage::Vectortypes::TGLMatrix FBaseProjectionMatrix;
	Stage::Vectortypes::TGLVector FCameraAbsolutePosition;
...
protected:
	...
	void __fastcall DoBaseRender(const Stage::Vectorgeometry::TRectangle &aViewPort, int resolution, Gls::Rendercontextinfo::TGLDrawState drawState, TGLBaseSceneObject* baseObject);
...
public:
	...
	void __fastcall PickObjects(const Winapi::Windows::TRect &rect, Gls::Selection::TGLPickList* pickList, int objectCountGuess);
	Gls::Selection::TGLPickList* __fastcall GetPickedObjects(const Winapi::Windows::TRect &rect, int objectCountGuess = 0x40);
	...
	Stage::Vectortypes::TGLMatrix __fastcall ProjectionMatrix _DEPRECATED_ATTRIBUTE0 ();
	Stage::Vectortypes::TGLMatrix __fastcall ViewMatrix _DEPRECATED_ATTRIBUTE0 ();
	Stage::Vectortypes::TGLMatrix __fastcall ModelMatrix _DEPRECATED_ATTRIBUTE0 ();
	__property Stage::Vectortypes::TGLMatrix BaseProjectionMatrix = {read=FBaseProjectionMatrix};
	void __fastcall PushViewMatrix _DEPRECATED_ATTRIBUTE0 (const Stage::Vectortypes::TGLMatrix &newMatrix);
	void __fastcall PopViewMatrix _DEPRECATED_ATTRIBUTE0 ();
	void __fastcall PushProjectionMatrix _DEPRECATED_ATTRIBUTE0 (const Stage::Vectortypes::TGLMatrix &newMatrix);
	...
	Stage::Vectortypes::TGLVector __fastcall ScreenToWorld(const Stage::Vectortypes::TGLVector &aPoint)/* overload */;
	...
	Stage::Vectortypes::TGLVector __fastcall WorldToScreen(const Stage::Vectortypes::TGLVector &aPoint)/* overload */;
	void __fastcall WorldToScreen(Stage::Vectortypes::PGLVector points, int nbPoints)/* overload */;
	Stage::Vectorgeometry::TAffineVector __fastcall ScreenToVector(const Stage::Vectorgeometry::TAffineVector &aPoint)/* overload */;
	Stage::Vectortypes::TGLVector __fastcall ScreenToVector(const Stage::Vectortypes::TGLVector &aPoint)/* overload */;
	Stage::Vectortypes::TGLVector __fastcall ScreenToVector(const int x, const int y)/* overload */;
	Stage::Vectorgeometry::TAffineVector __fastcall VectorToScreen(const Stage::Vectorgeometry::TAffineVector &VectToCam);
	bool __fastcall ScreenVectorIntersectWithPlane(const Stage::Vectortypes::TGLVector &aScreenPoint, const Stage::Vectortypes::TGLVector &planePoint, const Stage::Vectortypes::TGLVector &planeNormal, Stage::Vectortypes::TGLVector &intersectPoint);
	bool __fastcall ScreenVectorIntersectWithPlaneXY(const Stage::Vectortypes::TGLVector &aScreenPoint, const float z, Stage::Vectortypes::TGLVector &intersectPoint);
	bool __fastcall ScreenVectorIntersectWithPlaneYZ(const Stage::Vectortypes::TGLVector &aScreenPoint, const float x, Stage::Vectortypes::TGLVector &intersectPoint);
	bool __fastcall ScreenVectorIntersectWithPlaneXZ(const Stage::Vectortypes::TGLVector &aScreenPoint, const float y, Stage::Vectortypes::TGLVector &intersectPoint);
...
#define GLSCENE_REVISION L"$Revision: 2024$"
#define GLSCENE_VERSION L"v2.5 %s"
