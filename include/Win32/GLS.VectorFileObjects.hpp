...
// (DO NOT EDIT: machine generated header) 'GLS.VectorFileObjects.pas' rev: 36.00 (Windows)
...
protected:
	Stage::Vectortypes::TGLMatrix FGlobalMatrix;
...
public:
	...
	__property Stage::Vectortypes::TGLMatrix GlobalMatrix = {read=FGlobalMatrix, write=FGlobalMatrix};
public:
...
public:
	...
	virtual TGLSkeletonBone* __fastcall BoneByID(int anID);
	virtual TGLSkeletonBone* __fastcall BoneByName(const System::UnicodeString aName);
	void __fastcall SetGlobalMatrix(const Stage::Vectortypes::TGLMatrix &Matrix);
	void __fastcall SetGlobalMatrixForRagDoll(const Stage::Vectortypes::TGLMatrix &RagDollMatrix);
	virtual void __fastcall PrepareGlobalMatrices();
	__property Stage::Vectortypes::TGLMatrix GlobalMatrix = {read=FGlobalMatrix};
...
protected:
	...
	void __fastcall SetLocalMatrix(const Stage::Vectortypes::TGLMatrix &val);
...
public:
	...
	__property Stage::Vectortypes::TGLMatrix LocalMatrix = {read=FLocalMatrix, write=SetLocalMatrix};
	__property Stage::Vectortypes::TGLMatrix GlobalMatrix = {read=FGlobalMatrix};
...
public:
	...
	Stage::Vectortypes::TGLVector __fastcall GetBarycenter();
	virtual void __fastcall Prepare();
	virtual bool __fastcall PointInObject(const Stage::Vectorgeometry::TAffineVector &aPoint);
	void __fastcall GetTriangleData(int tri, Gls::Vectorlists::TGLAffineVectorList* list, Stage::Vectorgeometry::TAffineVector &v0, Stage::Vectorgeometry::TAffineVector &v1, Stage::Vectorgeometry::TAffineVector &v2)/* overload */;
	void __fastcall GetTriangleData(int tri, Gls::Vectorlists::TGLVectorList* list, Stage::Vectortypes::TGLVector &v0, Stage::Vectortypes::TGLVector &v1, Stage::Vectortypes::TGLVector &v2)/* overload */;
	void __fastcall SetTriangleData(int tri, Gls::Vectorlists::TGLAffineVectorList* list, const Stage::Vectorgeometry::TAffineVector &v0, const Stage::Vectorgeometry::TAffineVector &v1, const Stage::Vectorgeometry::TAffineVector &v2)/* overload */;
	void __fastcall SetTriangleData(int tri, Gls::Vectorlists::TGLVectorList* list, const Stage::Vectortypes::TGLVector &v0, const Stage::Vectortypes::TGLVector &v1, const Stage::Vectortypes::TGLVector &v2)/* overload */;
...
private:
	PGLVerticesBoneWeights FVerticesBonesWeights;
...
public:
	...
	int __fastcall FindOrAdd(const TGLVertexBoneWeightDynArray boneIDs, const Stage::Vectorgeometry::TAffineVector &vertex, const Stage::Vectorgeometry::TAffineVector &normal)/* overload */;
...
protected:
	...
	void __fastcall SetAutoScaling(Gls::Coordinates::TGLCoordinates* const Value);
...
public:
	...
	Stage::Vectortypes::TGLVector __fastcall BarycenterOffset();
	Stage::Vectortypes::TGLVector __fastcall BarycenterPosition();
	...
	__property Gls::Coordinates::TGLCoordinates* AutoScaling = {read=FAutoScaling, write=FAutoScaling};
...
public:
	...
	bool __fastcall OctreeSphereSweepIntersect(const Stage::Vectortypes::TGLVector &rayStart, const Stage::Vectortypes::TGLVector &rayVector, const float velocity, const float radius, Stage::Vectortypes::PGLVector intersectPoint = (Stage::Vectortypes::PGLVector)(0x0), Stage::Vectortypes::PGLVector intersectNormal = (Stage::Vectortypes::PGLVector)(0x0));
	...
	bool __fastcall OctreePointInMesh(const Stage::Vectortypes::TGLVector &Point);
	bool __fastcall OctreeAABBIntersect(const Gls::Geometrybb::TAABB &AABB, const Stage::Vectortypes::TGLMatrix &objMatrix, const Stage::Vectortypes::TGLMatrix &invObjMatrix, Gls::Vectorlists::TGLAffineVectorList* triangles = (Gls::Vectorlists::TGLAffineVectorList*)(0x0));
