...
// (DO NOT EDIT: machine generated header) 'GLS.BitmapFont.pas' rev: 36.00 (Windows)
...
protected:
	...
	void __fastcall GetICharTexCoords(Gls::Rendercontextinfo::TGLRenderContextInfo &ARci, int Chi, /* out */ Stage::Vectorgeometry::TTexPoint &TopLeft, /* out */ Stage::Vectorgeometry::TTexPoint &BottomRight);
...
public:
	...
	virtual void __fastcall RenderString(Gls::Rendercontextinfo::TGLRenderContextInfo &ARci, const System::UnicodeString aText, System::Classes::TAlignment aAlignment, Vcl::Stdctrls::TTextLayout aLayout, const Gls::Color::TGLColorVector &aColor, Stage::Vectortypes::PGLVector aPosition = (Stage::Vectortypes::PGLVector)(0x0), bool aReverseY = false)/* overload */;
	void __fastcall TextOut(Gls::Rendercontextinfo::TGLRenderContextInfo &rci, float X, float Y, const System::UnicodeString Text, const Gls::Color::TGLColorVector &Color)/* overload */;
