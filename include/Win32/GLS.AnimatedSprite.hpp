...
// (DO NOT EDIT: machine generated header) 'GLS.AnimatedSprite.pas' rev: 36.00 (Windows)
...
protected:
	...
	void __fastcall SetLibMaterialName(const Gls::Material::TGLLibMaterialName val);
