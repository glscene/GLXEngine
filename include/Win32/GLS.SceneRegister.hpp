...
// (DO NOT EDIT: machine generated header) 'GLS.SceneRegister.pas' rev: 36.00 (Windows)
...
protected:
	System::Uitypes::TColor __fastcall ColorToBorderColor(const Gls::Color::TGLColorVector &aColor, bool selected);
