...
// (DO NOT EDIT: machine generated header) 'GLSL.PostShaders.pas' rev: 36.00 (Windows)
...
private:
	...
	Gls::Material::TGLLibMaterialName FMaskTexName;
	void __fastcall DoUseTempTexture(Gls::Context::TGLTextureHandle* const TempTexture, Stage::Textureformat::TglTextureTarget TextureTarget);
	Stage::Textureformat::TglTextureTarget __fastcall GetTextureTarget();
	...
	Gls::Material::TGLLibMaterialName __fastcall GetMaskTexName();
	void __fastcall SetMaskTexName(const Gls::Material::TGLLibMaterialName Value);
...
public:
	...
	__property Gls::Material::TGLLibMaterialName NoiseTexName = {read=GetNoiseTexName, write=SetNoiseTexName};
	__property Gls::Texture::TGLTexture* MaskTex = {read=FMaskTex, write=SetMaskTexTexture};
	__property Gls::Material::TGLLibMaterialName MaskTexName = {read=GetMaskTexName, write=SetMaskTexName};
