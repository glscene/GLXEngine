...
typedef unsigned *PPasDblStrUtilsPtrUInt;

typedef int *PPasDblStrUtilsPtrInt;

typedef System::NativeUInt TPasDblStrUtilsPtrUInt;

typedef System::NativeInt TPasDblStrUtilsPtrInt;

typedef unsigned *PPasDblStrUtilsNativeUInt;

typedef int *PPasDblStrUtilsNativeInt;
