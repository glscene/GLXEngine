...
// (DO NOT EDIT: machine generated header) 'GLS.GeometryBB.pas' rev: 36.00 (Windows)
...
extern DELPHI_PACKAGE Gls::Vectorlists::TGLAffineVectorList* __fastcall PlaneAABBIntersection(const Stage::Vectorgeometry::THmgPlane &plane, const TAABB &AABB);
