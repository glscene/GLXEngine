...
// (DO NOT EDIT: machine generated header) 'GXS.XCollection.pas' rev: 36.00 (Windows)

#ifndef GXS_XCollectionHPP
#define GXS_XCollectionHPP
...
class PASCALIMPLEMENTATION TXCollectionItem : public Gxs::Persistentclasses::TgxInterfacedPersistent
{
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GXS_XCOLLECTION)
using namespace Gxs::Xcollection;
#endif
