...
_DECLARE_METACLASS(System::TMetaClass, TgxVirtualReaderClass);

_DECLARE_METACLASS(System::TMetaClass, TgxVirtualWriterClass);
...
_DECLARE_METACLASS(System::TMetaClass, TgxPersistentObjectClass);

typedef System::StaticArray<System::TObject*, 134217728> TgxPointerObjectList;
