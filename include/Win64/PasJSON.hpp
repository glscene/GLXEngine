...
typedef unsigned __int64 *PPasJSONPtrUInt;

typedef PPasJSONPtrUInt *PPPasJSONPtrUInt;

typedef __int64 *PPasJSONPtrInt;
...
typedef unsigned __int64 *PPasJSONSize;

typedef TPasJSONPtrUInt TPasJSONSize;

typedef __int64 *PPasJSONPtrDiff;
...
__published:
	__property TPasJSONSizeInt Position = {read=fPosition, write=fPosition};
public:
...
public:
	...
	virtual void __fastcall Merge(TPasJSONItem* const aWith, const TPasJSONMergeFlags aFlags = TPasJSONMergeFlags() );
	__property TPasJSONSizeInt Count = {read=fCount};
...
public:
	...
	static TPasJSONInt64 __fastcall GetInt64(TPasJSONItem* const aItem, const TPasJSONInt64 aDefault = (__int64)(0LL));
