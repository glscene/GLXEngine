...
// (DO NOT EDIT: machine generated header) 'Newton.Import.pas' rev: 36.00 (Windows)

#ifndef Newton_ImportHPP
#define Newton_ImportHPP
...
public:
	...
	PdFloat m_vertex;
	PInteger m_faceIndexCount;
	PInteger m_faceVertexIndex;
};
#pragma pack(pop)
...
typedef void __cdecl (*NewtonPostUpdateCallback)(const PNewtonWorld world, dFloat timestep);
...
typedef void __cdecl (*NewtonWorldUpdateListenerCallback)(const PNewtonWorld world, const void * listenerUserData, dFloat timestep);
...
typedef dFloat __cdecl (*NewtonUserMeshCollisionRayHitCallback)(const PNewtonUserMeshCollisionRayHitDesc lineDescData);
...
typedef dFloat __cdecl (*NewtonCollisionTreeRayCastCallback)(const PNewtonBody body, const PNewtonCollision treeCollision, dFloat intersection, const PFloat normal, int faceId, const void * usedData);

typedef NewtonCollisionTreeRayCastCallback *PNewtonCollisionTreeRayCastCallback;

typedef dFloat __cdecl (*NewtonHeightFieldRayCastCallback)(const PNewtonBody body, const PNewtonCollision heightFieldCollision, dFloat intersection, int row, int col, const PFloat normal, int faceId, const void * usedData);
...
typedef System::LongWord __cdecl (*NewtonWorldRayPrefilterCallback)(const PNewtonBody body, const PNewtonCollision collision, const void * userData);

typedef NewtonWorldRayPrefilterCallback *PNewtonWorldRayPrefilterCallback;

typedef dFloat __cdecl (*NewtonWorldRayFilterCallback)(const PNewtonBody body, const PNewtonCollision shapeHit, const PFloat hitContact, const PFloat hitNormal, __int64 collisionID, const void * userData, dFloat intersectParam);

typedef NewtonWorldRayFilterCallback *PNewtonWorldRayFilterCallback;

typedef int __cdecl (*NewtonOnAABBOverlap)(const PNewtonJoint contact, dFloat timestep, int threadIndex);
...
typedef int __cdecl (*NewtonOnCompoundSubCollisionAABBOverlap)(const PNewtonJoint contact, dFloat timestep, const PNewtonBody body0, const void * collisionNode0, const PNewtonBody body1, const void * collisionNode1, int threadIndex);
...
typedef System::LongWord __cdecl (*NewtonHingeCallback)(const PNewtonJoint hinge, const PNewtonHingeSliderUpdateDesc desc);

typedef NewtonHingeCallback *PNewtonHingeCallback;

typedef System::LongWord __cdecl (*NewtonSliderCallback)(const PNewtonJoint slider, const PNewtonHingeSliderUpdateDesc desc);

typedef NewtonSliderCallback *PNewtonSliderCallback;

typedef System::LongWord __cdecl (*NewtonUniversalCallback)(const PNewtonJoint universal, const PNewtonHingeSliderUpdateDesc desc);

typedef NewtonUniversalCallback *PNewtonUniversalCallback;

typedef System::LongWord __cdecl (*NewtonCorkscrewCallback)(const PNewtonJoint corkscrew, const PNewtonHingeSliderUpdateDesc desc);
...
typedef int __cdecl (*NewtonReportProgress)(dFloat normalizedProgressPercent, const void * userData);

typedef NewtonReportProgress *PNewtonReportProgress;

//-- var, const, procedure ---------------------------------------------------
#define NEWTON_API L"newton64s.dll"
...
static _DELPHI_CONST System::Int8 NEWTON_BROADPHASE_PERSINTENT = System::Int8(0x1);
static _DELPHI_CONST System::Int8 NEWTON_DYNAMIC_BODY = System::Int8(0x0);
static _DELPHI_CONST System::Int8 NEWTON_KINEMATIC_BODY = System::Int8(0x1);
static _DELPHI_CONST System::Int8 NEWTON_DYNAMIC_ASYMETRIC_BODY = System::Int8(0x2);
...
extern "C" dFloat __cdecl NewtonGetContactMergeTolerance(const PNewtonWorld newtonWorld);
extern "C" void __cdecl NewtonSetContactMergeTolerance(const PNewtonWorld newtonWorld, dFloat tolerance);
...
extern "C" void __cdecl NewtonUpdateAsync(const PNewtonWorld newtonWorld, dFloat timestep);
...
extern "C" dFloat __cdecl NewtonGetLastUpdateTime(const PNewtonWorld newtonWorld);
...
extern "C" System::LongWord __cdecl NewtonMaterialGetContactFaceAttribute(const PNewtonMaterial material);
...
extern "C" dFloat __cdecl NewtonMaterialGetContactMaxNormalImpact(const PNewtonMaterial material);
extern "C" dFloat __cdecl NewtonMaterialGetContactMaxTangentImpact(const PNewtonMaterial material, int index);
extern "C" dFloat __cdecl NewtonMaterialGetContactPenetration(const PNewtonMaterial material);
extern "C" void __cdecl NewtonMaterialSetAsSoftContact(const PNewtonMaterial material, dFloat relaxation);
extern "C" void __cdecl NewtonMaterialSetContactSoftness(const PNewtonMaterial material, dFloat softness);
extern "C" void __cdecl NewtonMaterialSetContactThickness(const PNewtonMaterial material, dFloat thickness);
...
extern "C" void __cdecl NewtonMaterialSetContactTangentFriction(const PNewtonMaterial material, dFloat friction, int index);
...
extern "C" dFloat __cdecl NewtonMaterialGetContactPruningTolerance(const PNewtonJoint contactJoint);
extern "C" void __cdecl NewtonMaterialSetContactPruningTolerance(const PNewtonJoint contactJoint, dFloat tolerance);
extern "C" PNewtonCollision __cdecl NewtonCreateNull(const PNewtonWorld newtonWorld);
extern "C" PNewtonCollision __cdecl NewtonCreateSphere(const PNewtonWorld newtonWorld, dFloat radius, int shapeID, const PFloat offsetMatrix);
extern "C" PNewtonCollision __cdecl NewtonCreateBox(const PNewtonWorld newtonWorld, dFloat dx, dFloat dy, dFloat dz, int shapeID, const PFloat offsetMatrix);
extern "C" PNewtonCollision __cdecl NewtonCreateCone(const PNewtonWorld newtonWorld, dFloat radius, dFloat height, int shapeID, const PFloat offsetMatrix);
extern "C" PNewtonCollision __cdecl NewtonCreateCapsule(const PNewtonWorld newtonWorld, dFloat radius0, dFloat radius1, dFloat height, int shapeID, const PFloat offsetMatrix);
extern "C" PNewtonCollision __cdecl NewtonCreateCylinder(const PNewtonWorld newtonWorld, dFloat radio0, dFloat radio1, dFloat height, int shapeID, const PFloat offsetMatrix);
extern "C" PNewtonCollision __cdecl NewtonCreateChamferCylinder(const PNewtonWorld newtonWorld, dFloat radius, dFloat height, int shapeID, const PFloat offsetMatrix);
extern "C" PNewtonCollision __cdecl NewtonCreateConvexHull(const PNewtonWorld newtonWorld, int count, const PFloat vertexCloud, int strideInBytes, dFloat tolerance, int shapeID, const PFloat offsetMatrix);
extern "C" PNewtonCollision __cdecl NewtonCreateConvexHullFromMesh(const PNewtonWorld newtonWorld, const PNewtonMesh mesh, dFloat tolerance, int shapeID);
...
extern "C" dFloat __cdecl NewtonConvexCollisionCalculateBuoyancyVolume(const PNewtonCollision convexCollision, const PFloat matrix, const PFloat fluidPlane, const PFloat centerOfBuoyancy);
...
extern "C" PNewtonCollision __cdecl NewtonCreateCompoundCollisionFromMesh(const PNewtonWorld newtonWorld, const PNewtonMesh mesh, dFloat hullTolerance, int shapeID, int subShapeID);
...
extern "C" PNewtonCollision __cdecl NewtonCreateHeightFieldCollision(const PNewtonWorld newtonWorld, int width, int height, int gridsDiagonals, int elevationdatType, const void * elevationMap, const System::WideChar * attributeMap, dFloat verticalScale, dFloat horizontalScale_x, dFloat horizontalScale_z, int shapeID);
...
extern "C" void __cdecl NewtonHeightFieldSetHorizontalDisplacement(PNewtonCollision heightfieldCollision, System::PWord horizontalMap, dFloat scale);
...
extern "C" void __cdecl NewtonCollisionSetScale(const PNewtonCollision collision, dFloat scaleX, dFloat scaleY, dFloat scaleZ);
...
extern "C" dFloat __cdecl NewtonCollisionGetSkinThickness(const PNewtonCollision collision);
extern "C" void __cdecl NewtonCollisionSetSkinThickness(const PNewtonCollision collision, dFloat thickness);
...
extern "C" int __cdecl NewtonCollisionCollideContinue(const PNewtonWorld newtonWorld, int maxSize, dFloat timestep, const PNewtonCollision collisionA, const PFloat matrixA, const PFloat velocA, const PFloat omegaA, const PNewtonCollision collisionB, const PFloat matrixB, const PFloat velocB, const PFloat omegaB, const PFloat timeOfImpact, const PFloat contacts, const PFloat normals, const PFloat penetration, const System::PInt64 attributeA, const System::PInt64 attributeB, int threadIndex);
extern "C" void __cdecl NewtonCollisionSupportVertex(const PNewtonCollision collision, const PFloat dir, const PFloat vertex);
extern "C" dFloat __cdecl NewtonCollisionRayCast(const PNewtonCollision collision, const PFloat p0, const PFloat p1, const PFloat normal, const System::PInt64 attribute);
...
extern "C" void __cdecl NewtonBodyCalculateInverseDynamicsForce(PNewtonBody body, dFloat timestep, PdFloat desiredVeloc, PdFloat forceOut);
...
extern "C" void __cdecl NewtonBodySetFullMassMatrix(const PNewtonBody body, dFloat mass, const PFloat inertiaMatrix);
extern "C" void __cdecl NewtonBodySetMassProperties(const PNewtonBody body, dFloat mass, const PNewtonCollision collision);
...
extern "C" void __cdecl NewtonBodySetContinuousCollisionMode(const PNewtonBody body, System::LongWord state);
extern "C" void __cdecl NewtonBodySetJointRecursiveCollision(const PNewtonBody body, System::LongWord state);
...
extern "C" void __cdecl NewtonBodySetCollisionScale(const PNewtonBody body, dFloat scaleX, dFloat scaleY, dFloat scaleZ);
...
extern "C" void __cdecl NewtonBodyApplyImpulsePair(const PNewtonBody body, const PFloat linearImpulse, const PFloat angularImpulse, dFloat timestep);
extern "C" void __cdecl NewtonBodyAddImpulse(const PNewtonBody body, const PFloat pointDeltaVeloc, const PFloat pointPosit, dFloat timestep);
extern "C" void __cdecl NewtonBodyApplyImpulseArray(const PNewtonBody body, int impuleCount, int strideInByte, const PFloat impulseArray, const PFloat pointArray, dFloat timestep);
extern "C" void __cdecl NewtonBodyIntegrateVelocity(const PNewtonBody body, dFloat timestep);
...
extern "C" dFloat __cdecl NewtonContactJointGetClosestDistance(const PNewtonJoint contactJoint);
...
extern "C" void __cdecl NewtonBallSetConeLimits(const PNewtonJoint ball, const PFloat pin, dFloat maxConeAngle, dFloat maxTwistAngle);
...
extern "C" void __cdecl NewtonUpVectorGetPin(const PNewtonJoint upVector, dFloat pin);
extern "C" void __cdecl NewtonUpVectorSetPin(const PNewtonJoint upVector, const dFloat pin);
...
extern "C" void __cdecl NewtonUserJointMassScale(const PNewtonJoint joint, dFloat scaleBody0, dFloat scaleBody1);
...
extern "C" void __cdecl NewtonUserJointAddAngularRow(const PNewtonJoint joint, dFloat relativeAngle, const PFloat dir);
...
extern "C" dFloat __cdecl NewtonUserJointCalculateRowZeroAcceleration(const PNewtonJoint joint);
extern "C" dFloat __cdecl NewtonUserJointGetRowAcceleration(const PNewtonJoint joint);
...
extern "C" void __cdecl NewtonUserJointSetRowSpringDamperAcceleration(const PNewtonJoint joint, dFloat rowStiffness, dFloat spring, dFloat damper);
...
extern "C" PNewtonMesh __cdecl NewtonMeshCreateConvexHull(const PNewtonWorld newtonWorld, int pointCount, const PFloat vertexCloud, int strideInBytes, dFloat tolerance);
...
extern "C" PNewtonMesh __cdecl NewtonMeshApproximateConvexDecomposition(const PNewtonMesh mesh, dFloat maxConcavity, dFloat backFaceDistanceFactor, int maxCount, int maxVertexPerHull, NewtonReportProgress reportProgressCallback, const void * reportProgressUserData);
...
extern "C" void __cdecl NewtonMeshAddNormal(const PNewtonMesh mesh, dFloat x, dFloat y, dFloat z);
extern "C" void __cdecl NewtonMeshAddBinormal(const PNewtonMesh mesh, dFloat x, dFloat y, dFloat z);
extern "C" void __cdecl NewtonMeshAddUV0(const PNewtonMesh mesh, dFloat u, dFloat v);
extern "C" void __cdecl NewtonMeshAddUV1(const PNewtonMesh mesh, dFloat u, dFloat v);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_NEWTON_IMPORT)
using namespace Newton::Import;
#endif
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_NEWTON)
