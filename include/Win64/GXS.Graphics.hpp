...
public:
	...
	virtual bool __fastcall AssignFromTexture(Gxs::Context::TgxTextureHandle* AHandle, const bool CastToFormat, const Stage::Textureformat::TglInternalFormat intFormat = (Stage::Textureformat::TglInternalFormat)(0x1f), const System::NativeUInt colorFormat = (unsigned __int64)(0ULL), const System::NativeUInt dataType = (unsigned __int64)(0ULL));
...
_DECLARE_METACLASS(System::TMetaClass, TgxBaseImageClass);
