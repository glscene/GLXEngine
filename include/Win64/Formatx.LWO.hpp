...
// (DO NOT EDIT: machine generated header) 'Formatx.LWO.pas' rev: 36.00 (Windows)

#ifndef Formatx_LWOHPP
#define Formatx_LWOHPP
...
_DECLARE_METACLASS(System::TMetaClass, TLWChunkClass);
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FORMATX_LWO)
using namespace Formatx::Lwo;
#endif
