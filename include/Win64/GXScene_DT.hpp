...
// (DO NOT EDIT: machine generated header) 'GXScene_DT.dpk' rev: 36.00 (Windows)

#ifndef GXScene_DTHPP
#define GXScene_DTHPP
...
namespace Gxscene_dt
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Gxscene_dt */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GXSCENE_DT)
using namespace Gxscene_dt;
#endif
#pragma pack(pop)
#pragma option pop
