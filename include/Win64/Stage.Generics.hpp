...
// (DO NOT EDIT: machine generated header) 'Stage.Generics.pas' rev: 36.00 (Windows)

#ifndef Stage_GenericsHPP
#define Stage_GenericsHPP
...
public:
	typedef GList__1<T> TLockableList;
...
public:
	...
	void __fastcall Clear();
	TLockableList* __fastcall LockList();
...
private:
	typedef GList__1<T> TOrderedList;
...
protected:
	...
	__property TOrderedList* List = {read=FList};
...
public:
	/* {Stage_Generics}GOrderedList<Stage_Generics_GStack<T>_T>.Create */ inline __fastcall virtual GStack__1() : GOrderedList__1<T>() { }
	/* {Stage_Generics}GOrderedList<Stage_Generics_GStack<T>_T>.Destroy */ inline __fastcall virtual ~GStack__1() { }
...
protected:
	virtual void __fastcall PushItem(T AItem);
public:
	/* {Stage_Generics}GOrderedList<Stage_Generics_GQueue<T>_T>.Create */ inline __fastcall virtual GQueue__1() : GOrderedList__1<T>() { }
	/* {Stage_Generics}GOrderedList<Stage_Generics_GQueue<T>_T>.Destroy */ inline __fastcall virtual ~GQueue__1() { }
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_STAGE_GENERICS)
using namespace Stage::Generics;
#endif
