...
__published:
	...
	__property System::NativeUInt TotalGlobalMem = {read=fDeviceProperties.totalGlobalMem};
	__property System::NativeUInt SharedMemPerBlock = {read=fDeviceProperties.sharedMemPerBlock};
	...
	__property System::NativeUInt MemPitch = {read=fDeviceProperties.memPitch};
	...
	__property System::NativeUInt TotalConstMem = {read=fDeviceProperties.totalConstMem};
	__property int Major = {read=fDeviceProperties.major, nodefault};
	__property int Minor = {read=fDeviceProperties.minor, nodefault};
	__property System::NativeUInt TextureAlignment = {read=fDeviceProperties.textureAlignment};
