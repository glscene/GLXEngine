...
// (DO NOT EDIT: machine generated header) 'GXScene_Cg_RT.dpk' rev: 36.00 (Windows)

#ifndef GXScene_Cg_RTHPP
#define GXScene_Cg_RTHPP
...
#include <GXS.CgBombShader.hpp>
#include <GXS.CgPostTransformationShader.hpp>
#include <Cg.GL.hpp>
...
namespace Gxscene_cg_rt
{
//-- forward type declarations -----------------------------------------------
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------
}	/* namespace Gxscene_cg_rt */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_GXSCENE_CG_RT)
using namespace Gxscene_cg_rt;
#endif
#pragma pack(pop)
#pragma option pop
