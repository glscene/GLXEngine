...
// (DO NOT EDIT: machine generated header) 'Stage.Logger.pas' rev: 36.00 (Windows)

#ifndef Stage_LoggerHPP
#define Stage_LoggerHPP
...
typedef System::StaticArray<System::UnicodeString, 6> Stage_Logger__1;
...
_DECLARE_METACLASS(System::TMetaClass, CLogSession);
...
extern DELPHI_PACKAGE Stage_Logger__1 lkPrefix;
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_STAGE_LOGGER)
using namespace Stage::Logger;
#endif
