...
typedef unsigned __int64 *PPasGLTFPtrUInt;

typedef PPasGLTFPtrUInt *PPPasGLTFPtrUInt;

typedef __int64 *PPasGLTFPtrInt;
...
typedef unsigned __int64 *PPasGLTFSizeUInt;

typedef PPasGLTFSizeUInt *PPPasGLTFSizeUInt;

typedef TPasGLTFPtrUInt TPasGLTFSizeUInt;

typedef System::DynamicArray<unsigned __int64> TPasGLTFSizeUIntDynamicArray;

typedef __int64 *PPasGLTFSizeInt;

typedef PPasGLTFSizeInt *PPPasGLTFSizeInt;

typedef TPasGLTFPtrInt TPasGLTFSizeInt;

typedef System::DynamicArray<__int64> TPasGLTFSizeIntDynamicArray;

typedef unsigned __int64 *PPasGLTFNativeUInt;

typedef PPasGLTFNativeUInt *PPPasGLTFNativeUInt;

typedef TPasGLTFPtrUInt TPasGLTFNativeUInt;

typedef __int64 *PPasGLTFNativeInt;
...
typedef unsigned __int64 *PPasGLTFSize;

typedef TPasGLTFPtrUInt TPasGLTFSize;

typedef __int64 *PPasGLTFPtrDiff;
...
public:
	...
	__property TPasGLTFSizeInt Count = {read=fCount, write=SetCount};
	__property TPasGLTFSizeInt Allocated = {read=fAllocated};
...
public:
	...
	__published:
		...
		__property TPasGLTFSizeInt Scene = {read=fScene, write=fScene};
	...
	typedef TPasGLTFUTF8StringHashMap__1<__int64> TAttributes;
	...
	public:
		static System::StaticArray<__int64, 8> TypeComponentCountTable;
	...
	__published:
		__property TPasGLTFSizeUInt ByteLength = {read=fByteLength, write=fByteLength};
		__property TPasGLTFUTF8String Name = {read=fName, write=fName};
	...
	__published:
		__property TPasGLTFUTF8String Name = {read=fName, write=fName};
		__property TPasGLTFSizeInt Buffer = {read=fBuffer, write=fBuffer};
		__property TPasGLTFSizeUInt ByteOffset = {read=fByteOffset, write=fByteOffset};
		__property TPasGLTFSizeUInt ByteLength = {read=fByteLength, write=fByteLength};
		__property TPasGLTFSizeUInt ByteStride = {read=fByteStride, write=fByteStride};
	...
	__published:
		__property TPasGLTFSizeInt BufferView = {read=fBufferView, write=fBufferView};
		__property TPasGLTFUTF8String Name = {read=fName, write=fName};
		__property TPasGLTFUTF8String URI = {read=fURI, write=fURI};
	...
	public:
		...
		__published:
			__property TPasGLTFSizeInt Index = {read=fIndex, write=fIndex};
			__property TPasGLTFSizeInt TexCoord = {read=fTexCoord, write=fTexCoord};
			__property bool Empty = {read=GetEmpty, nodefault};
		};
	...
	public:
		...
		__published:
			...
			__property TPasGLTFSizeInt Indices = {read=fIndices, write=fIndices};
			__property TPasGLTFSizeInt Material = {read=fMaterial, write=fMaterial};
	...
	public:
		typedef TPasGLTFDynamicArray__1<__int64> TChildren;
		typedef TPasGLTFDynamicArray__1<float> TWeights;
	...
	__published:
		__property TPasGLTFUTF8String Name = {read=fName, write=fName};
		__property TPasGLTFSizeInt Camera = {read=fCamera, write=fCamera};
		__property TPasGLTFSizeInt Mesh = {read=fMesh, write=fMesh};
		__property TPasGLTFSizeInt Skin = {read=fSkin, write=fSkin};
	...
	public:
		typedef TPasGLTFDynamicArray__1<unsigned __int64> TNodes;
		
	private:
		TPasGLTFUTF8String fName;
		TPasGLTFDynamicArray__1<unsigned __int64>* fNodes;
	...
	__published:
		__property TPasGLTFUTF8String Name = {read=fName, write=fName};
		__property TPasGLTFDynamicArray__1<unsigned __int64>* Nodes = {read=fNodes};
	};
	...
	public:
		typedef TPasGLTFDynamicArray__1<unsigned __int64> TJoints;
		
	private:
		TPasGLTFUTF8String fName;
		TPasGLTFSizeInt fInverseBindMatrices;
		TPasGLTFSizeInt fSkeleton;
		TPasGLTFDynamicArray__1<unsigned __int64>* fJoints;
	...
	__published:
		__property TPasGLTFUTF8String Name = {read=fName, write=fName};
		__property TPasGLTFSizeInt InverseBindMatrices = {read=fInverseBindMatrices, write=fInverseBindMatrices};
		__property TPasGLTFSizeInt Skeleton = {read=fSkeleton, write=fSkeleton};
		__property TPasGLTFDynamicArray__1<unsigned __int64>* Joints = {read=fJoints};
	};
	...
	__published:
		__property TPasGLTFUTF8String Name = {read=fName, write=fName};
		__property TPasGLTFSizeInt Sampler = {read=fSampler, write=fSampler};
		__property TPasGLTFSizeInt Source = {read=fSource, write=fSource};
	};
