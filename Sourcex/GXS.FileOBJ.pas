...
procedure TOBJFGVertexNormalTexIndexList.AddToTriangles(aList: TGSAffineVectorList; aTexCoords: TGSAffineVectorList = nil;
...
procedure TOBJFGVertexNormalTexIndexList.ReadFromFiler(reader: TGSVirtualReader);
var
...
procedure TOBJFGVertexNormalTexIndexList.WriteToFiler(writer: TGSVirtualWriter);
begin
