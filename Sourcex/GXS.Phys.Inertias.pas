...
type
  ...
  published
    ...
    property TranslationSpeed: TGSCoordinates read FTranslationSpeed
  ...
  TgxInertiaTensor = class(TGSUpdateAbleObject)
  private
  ...
  public
    ...
    class function FriendlyDescription: String; override;
    class function UniqueItem: Boolean; override;
    // function Star(Vector:TAffineVector):TGSMatrix;
    ...
    procedure SetRotationSpeed(const val: TGSCoordinates);
  ...
  published
    ...
    property RotationSpeed: TGSCoordinates read fRotationSpeed
...
procedure TgxParticleInertia.SetTranslationSpeed(const val: TGSCoordinates);
begin
...
procedure TgxParticleInertia.SurfaceBounce(const surfaceNormal: TGSVector;
  restitution: Single);
var
  f: Single;
begin
...
procedure TgxRigidBodyInertia.SetRotationSpeed(const val: TGSCoordinates);
begin
...
(*
 function TgxRigidBodyInertia.Star(Vector:TAffineVector):TGSMatrix;
  begin
...
begin
  ...
  fRotationSpeed := TGSCoordinates.CreateInitialized(Self, VectorMake(0, 0, 0));
