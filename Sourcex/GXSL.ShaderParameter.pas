...
const
  cGXSLTypeString: array[TGXSLDataType] of AnsiString = (
    'undefined',
    'float',
    'vec2',
    'vec3',
  ...
  cGXSLSamplerString: array[TGXSLSamplerType] of AnsiString = (
    'undefined',
    'sampler1D',
    'sampler2D',
    'sampler3D',
...
const
  cGLgsInTypes : array[TGXSLInTypes] of Cardinal =
    (GL_POINTS, GL_LINES, GL_LINES_ADJACENCY_EXT, GL_TRIANGLES,
     GL_TRIANGLES_ADJACENCY_EXT);
  cGLgsOutTypes: array[TGXSLOutTypes] of Cardinal =
    (GL_POINTS, GL_LINE_STRIP, GL_TRIANGLE_STRIP);

type
  TUniformAutoSetMethod = procedure(Sender: IShaderParameter; var ARci: TgxRenderContextInfo) of object;

function GLSLTypeEnum(AType: TGXSLDataType): Cardinal;
...
const
  ...
  cGXSLTypeEnum: array[TGXSLDataType] of Integer =
  (
    0,
    GL_FLOAT,
    GL_FLOAT,
...
function GLSLTypeEnum(AType: TGXSLDataType): Cardinal;
begin
  Result := cGXSLTypeEnum[AType];
end;

function GLSLTypeComponentCount(AType: TGXSLDataType): Integer;
begin
  Result := cGXSLTypeComponents[AType];
end;
