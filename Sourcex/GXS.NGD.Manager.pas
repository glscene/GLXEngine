...
uses
  ...
  Stage.Manager,
  Stage.VectorLists, // TAffineVectorList for Tree
...
type
  ...
  published
    ...
    property AABBColorSleep: TGSColor read FAABBColorSleep
      write FAABBColorSleep;
    property CenterOfMassColor: TGSColor read FCenterOfMassColor
      write FCenterOfMassColor;
    property ContactColor: TGSColor read FContactColor write FContactColor;
    property JointAxisColor: TGSColor read FJointAxisColor
      write FJointAxisColor;
    property JointPivotColor: TGSColor read FJointPivotColor
      write FJointPivotColor;
    property ForceColor: TGSColor read FForceColor write FForceColor;
    property AppliedForceColor: TGSColor read FAppliedForceColor
      write FAppliedForceColor;
    property AppliedVelocityColor: TGSColor read FAppliedVelocityColor
  ...
  published
    ...
    property WorldSizeMin: TGSCoordinates read FWorldSizeMin
      write FWorldSizeMin;
    property WorldSizeMax: TGSCoordinates read FWorldSizeMax
      write FWorldSizeMax;
  ...
  published
    ...
    property CenterOfMass: TGSCoordinates read FCenterOfMass
      write FCenterOfMass;
    ...
    property AngularDamping: TGSCoordinates read FAngularDamping
  ...
  public
    ...
    destructor Destroy; override;
  published
    property PinDirection: TGSCoordinates read FPinDirection
      write FPinDirection;
  end;
  ...
  public
    ...
    destructor Destroy; override;
  published
    property PinDirection2: TGSCoordinates read FPinDirection2
  ...
  published
    ...
    property UPVectorDirection: TGSCoordinates read FUPVectorDirection
...
begin
  ...
  begin
    ...
    FAABBColorSleep := TGSColor.CreateInitialized(self, clrOrange,
      NotifyChange);
    FCenterOfMassColor := TGSColor.CreateInitialized(self, clrPurple,
      NotifyChange);
    ...
    FJointPivotColor := TGSColor.CreateInitialized(self, clrAquamarine,
      NotifyChange);

    FForceColor := TGSColor.CreateInitialized(self, clrBlack, NotifyChange);
    FAppliedForceColor := TGSColor.CreateInitialized(self, clrSilver,
      NotifyChange);
    FAppliedVelocityColor := TGSColor.CreateInitialized(self, clrLime,
      NotifyChange);
...
procedure TgxNGDManager.AddNode(const coords: TGSCustomCoordinates);
begin
  if Assigned(FGLLines) then
  begin
...
begin
  ...
  FWorldSizeMin := TGSCoordinates.CreateInitialized(self,
    VectorMake(-100, -100, -100, 0), csPoint);
  FWorldSizeMax := TGSCoordinates.CreateInitialized(self,
    VectorMake(100, 100, 100, 0), csPoint);
  ...
  FThreadCount := 1;
  FGravity := TGSCoordinates3.CreateInitialized(self,
...
begin
  ...
  begin
    ...
    if Sender is TGSCoordinates then
      BuildOneJoint(((Sender as TGSCoordinates).Owner as TgxNGDJoint));
...
begin
  ...
  FAutoSleep := True;
  FLinearDamping := 0.1;
  FAngularDamping := TGSCoordinates.CreateInitialized(self,
  ...
  FCenterOfMass := TGSCoordinates.CreateInitialized(self,
  ...
  FAppliedOmega := TGSCoordinates.CreateInitialized(self, NullHmgVector,
    csVector);
  FAppliedVelocity := TGSCoordinates.CreateInitialized(self, NullHmgVector,
    csVector);
  FAppliedForce := TGSCoordinates.CreateInitialized(self, NullHmgVector,
    csVector);
  FAppliedTorque := TGSCoordinates.CreateInitialized(self, NullHmgVector,
    csVector);
  FUseGravity := True;
...
begin
  ...
  FUPVectorDirection := TGSCoordinates.CreateInitialized(self, YHmgVector,
    csVector);
...
begin
  FManager := AOwner as TgxNGDManager;
  FOuter := aOuter;
  FPivotPoint := TGSCoordinates.CreateInitialized(aOuter, NullHMGPoint,
    csPoint);
...
begin
  inherited;
  FPinDirection := TGSCoordinates.CreateInitialized(aOuter, NullHmgVector,
    csVector);
...
begin
  inherited;
  FPinDirection2 := TGSCoordinates.CreateInitialized(aOuter, NullHmgVector,
    csVector);
