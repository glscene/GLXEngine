...
type
  ...
  private
    FAnchor, FAxis1, FAxis2: TGSCoordinates;
...
procedure TgxODEManager.SetGravity(Value: TGSCoordinates);
begin
...
procedure TgxODEManager.SetGeomColorDynD(const Value: TGSColor);
begin
...
procedure TgxODEManager.SetGeomColorDynE(const Value: TGSColor);
begin
...
procedure TgxODEManager.SetGeomColorStat(const Value: TGSColor);
begin
...
procedure TgxODEElementBase.SetPosition(const Value: TGSCoordinates);
begin
  FPosition.Assign(Value);
end;

procedure TgxODEElementBase.SetDirection(const Value: TGSCoordinates);
begin
  FDirection.Assign(Value);
end;

procedure TgxODEElementBase.SetUp(const Value: TGSCoordinates);
begin
  FUp.Assign(Value);
end;
...
procedure TgxODEElementTriMesh.SetVertices(const Value: TGSAffineVectorList);
begin
  FVertices.Assign(Value);
  RefreshTriMeshData;
end;

procedure TgxODEElementTriMesh.SetIndices(const Value: TGSIntegerList);
begin
...
procedure TgxODEJointHinge.SetAnchor(const Value: TGSCoordinates);
begin
  FAnchor.Assign(Value);
end;

procedure TgxODEJointHinge.SetAxis(const Value: TGSCoordinates);
begin
  FAxis.Assign(Value);
end;
...
procedure TgxODEJointBall.SetAnchor(const Value: TGSCoordinates);
begin
  FAnchor.Assign(Value);
end;
...
procedure TgxODEJointSlider.SetAxis(const Value: TGSCoordinates);
begin
  FAxis.Assign(Value);
end;
...
procedure TgxODEJointHinge2.SetAnchor(const Value: TGSCoordinates);
begin
  FAnchor.Assign(Value);
end;

procedure TgxODEJointHinge2.SetAxis1(const Value: TGSCoordinates);
begin
  FAxis1.Assign(Value);
end;

procedure TgxODEJointHinge2.SetAxis2(const Value: TGSCoordinates);
begin
  FAxis2.Assign(Value);
end;
...
procedure TgxODEJointUniversal.SetAnchor(const Value: TGSCoordinates);
begin
  FAnchor.Assign(Value);
end;

procedure TgxODEJointUniversal.SetAxis1(const Value: TGSCoordinates);
begin
  FAxis1.Assign(Value);
end;

procedure TgxODEJointUniversal.SetAxis2(const Value: TGSCoordinates);
begin
  FAxis2.Assign(Value);
end;
...
procedure TgxODECustomCollider.SetContactColor(const Value: TGSColor);
begin
