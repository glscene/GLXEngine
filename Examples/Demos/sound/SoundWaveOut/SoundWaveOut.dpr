(* 3D Sound sample (WaveOut manager is used in this sample).
   ...
   referred and used by the TGLSMWaveOut sound manager.
   ...
   soundtrack, it can be stereo (use the Sound System API directly to play it).
*)

program SoundWaveOut;

uses
  Forms,
  fdSoundWaveout in 'fdSoundWaveout.pas' {FormSoundWaveout};

{$R *.RES}

begin
  Application.Initialize;
  Application.CreateForm(TFormSoundWaveout, FormSoundWaveout);
  Application.Run;
end.
