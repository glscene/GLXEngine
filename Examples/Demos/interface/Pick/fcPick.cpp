...
TFormPick *FormPick;
//---------------------------------------------------------------------------
__fastcall TFormPick::TFormPick(TComponent* Owner)
	: TForm(Owner)
{
}
//---------------------------------------------------------------------------
void __fastcall TFormPick::glsViewerMouseMove(TObject *Sender, TShiftState Shift,
		  int X, int Y)
{
	...
	pick = (TGLCustomSceneObject *) glsViewer->Buffer->GetPickedObject(X, Y);
...
//---------------------------------------------------------------------------
void __fastcall TFormPick::glsViewerMouseDown(TObject *Sender, TMouseButton Button,
