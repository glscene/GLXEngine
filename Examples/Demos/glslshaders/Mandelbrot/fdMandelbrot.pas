...
//----------------------------------------------------------------------------
procedure TFormMandelbrot.Timer1Timer(Sender: TObject);
begin
...
//----------------------------------------------------------------------------
procedure TFormMandelbrot.GLCadencerProgress(Sender: TObject;
  const deltaTime, newTime: Double);
var
...
//----------------------------------------------------------------------------
procedure TFormMandelbrot.FormMouseWheel(Sender: TObject; Shift: TShiftState;
  WheelDelta: Integer; MousePos: TPoint; var Handled: Boolean);
var
  DistDelta: Single;
begin
...
//----------------------------------------------------------------------------
procedure TFormMandelbrot.MandelbrotRender(Sender: TObject;
